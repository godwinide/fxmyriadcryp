! function() {
        ...
        ! function(t, n) {
            ...
            function c(t, e, n, r) {
                if (Et(t)) {
                    var i, s, o = ft.expando,
                        ...
                        l = a ? ft.cache : t,
                        u = a ? t[o] : t[o] && o;
                    if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof e) return u || (u = a ? t[o] = nt.pop() || ft.guid++ : o), l[u] || (l[u] = a ? {} : {
                        toJSON: ft.noop
                    }), ("object" == typeof e || "function" == typeof e) && (r ? l[u] = ft.extend(l[u], e) : l[u].data = ft.extend(l[u].data, e)), s = l[u], r || (s.data || (s.data = {}), s = s.data), void 0 !== n && (s[ft.camelCase(e)] = n), "string" == typeof e ? (i = s[e], null == i && (i = s[ft.camelCase(e)])) : i = s, i
                }
            }
            ...
            function h(t, e, n) {
                if (Et(t)) {
                    ...
                    if (o[a]) {
                        ...
                        }(n || (delete o[a].data, u(o[a]))) && (s ? ft.cleanData([t], !0) : ht.deleteExpando || o != o.window ? delete o[a] : o[a] = void 0)
                    }
                }
            }
            ...
            function d(t, e, n, r) {
                var i, s = 1,
                    ...
                    c = (ft.cssNumber[e] || "px" !== u && +l) && Lt.exec(ft.css(t, e));
                if (c && c[3] !== u) {
                    u = u || c[3], n = n || [], c = +l || 1;
                    do s = s || ".5", c /= s, ft.style(t, e, c + u); while (s !== (s = a() / l) && 1 !== s && --o)
                }
            ...
            function p(t, e) {
                ...
                if (!s)
                    for (s = [], n = t.childNodes || t; null != (r = n[i]); i++) !e || ft.nodeName(r, e) ? s.push(r) : ft.merge(s, p(r, e));
            ...
            function y(t, e, n, r, i) {
                for (var s, o, a, l, u, c, h, d = t.length, y = f(e), v = [], w = 0; d > w; w++)
                    ...
                    for (l = l || y.appendChild(e.createElement("div")), u = (qt.exec(o) || ["", ""])[1].toLowerCase(), h = zt[u] || zt._default, l.innerHTML = h[1] + ft.htmlPrefilter(o) + h[2], s = h[0]; s--;) l = l.lastChild;
                    if (!ht.leadingWhitespace && Bt.test(o) && v.push(e.createTextNode(Bt.exec(o)[0])), !ht.tbody)
                        for (o = "table" !== u || Vt.test(o) ? "<table>" !== h[1] || Vt.test(o) ? 0 : l : l.firstChild, s = o && o.childNodes.length; s--;) ft.nodeName(c = o.childNodes[s], "tbody") && !c.childNodes.length && o.removeChild(c);
                    for (ft.merge(v, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
                    l = y.lastChild
                } else v.push(e.createTextNode(o));
                for (l && y.removeChild(l), ht.appendChecked || ft.grep(p(v, "input"), g), w = 0; o = v[w++];)
                    if (r && ft.inArray(o, r) > -1) i && i.push(o);
                    else if (a = ft.contains(o.ownerDocument, o), l = p(y.appendChild(o), "script"), a && m(l), n)
                    for (s = 0; o = l[s++];) It.test(o.type || "") && n.push(o);
                return l = null, y
            }
            ...
            function M(t, e, n, r) {
                ...
                var i, s, o, a, l, u, c = 0,
                    ...
                    f = e[0],
                    m = ft.isFunction(f);
                if (m || h > 1 && "string" == typeof f && !ht.checkClone && re.test(f)) return t.each(function(i) {
                    var s = t.eq(i);
                    m && (e[0] = f.call(this, i, s.html())), M(s, e, n, r)
                });
                if (h && (u = y(e, t[0].ownerDocument, !1, t, r), i = u.firstChild, 1 === u.childNodes.length && (u = i), i || r)) {
                    for (a = ft.map(p(u, "script"), k), o = a.length; h > c; c++) s = u, c !== d && (s = ft.clone(s, !0, !0), o && ft.merge(a, p(s, "script"))), n.call(t[c], s, c);
                    if (o)
                        for (l = a[a.length - 1].ownerDocument, ft.map(a, S), c = 0; o > c; c++) s = a[c], It.test(s.type || "") && !ft._data(s, "globalEval") && ft.contains(l, s) && (s.src ? ft._evalUrl && ft._evalUrl(s.src) : ft.globalEval((s.text || s.textContent || s.innerHTML || "").replace(se, "")));
                    u = i = null
                }
                return t
            }
            ...
            function D(t, e, n) {
                for (var r, i = e ? ft.filter(e, t) : t, s = 0; null != (r = i[s]); s++) n || 1 !== r.nodeType || ft.cleanData(p(r)), r.parentNode && (n && ft.contains(r.ownerDocument, r) && m(p(r, "script")), r.parentNode.removeChild(r));
                return t
            }
            ...
            function A(t, e) {
                for (var n, r, i, s = [], o = 0, a = t.length; a > o; o++) r = t[o], r.style && (s[o] = ft._data(r, "olddisplay"), n = r.style.display, e ? (s[o] || "none" !== n || (r.style.display = ""), "" === r.style.display && Ht(r) && (s[o] = ft._data(r, "olddisplay", O(r.nodeName)))) : (i = Ht(r), (n && "none" !== n || !i) && ft._data(r, "olddisplay", i ? n : ft.css(r, "display"))));
            ...
            function P(t, e, n, r, i) {
                for (var s = n === (r ? "border" : "content") ? 4 : "width" === e ? 1 : 0, o = 0; 4 > s; s += 2) "margin" === n && (o += ft.css(t, n + Ft[s], !0, i)), r ? ("content" === n && (o -= ft.css(t, "padding" + Ft[s], !0, i)), "margin" !== n && (o -= ft.css(t, "border" + Ft[s] + "Width", !0, i))) : (o += ft.css(t, "padding" + Ft[s], !0, i), "padding" !== n && (o += ft.css(t, "border" + Ft[s] + "Width", !0, i)));
                return o
            }
            ...
            function L(t, e, n) {
                ...
                if (0 >= i || null == i) {
                    if (i = me(t, e, s), (0 > i || null == i) && (i = t.style[e]), he.test(i)) return i;
            ...
            function q(t, e, n) {
                ...
                })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], u = ft.css(t, "display"), c = "none" === u ? ft._data(t, "olddisplay") || O(t.nodeName) : u, "inline" === c && "none" === ft.css(t, "float") && (ht.inlineBlockNeedsLayout && "inline" !== O(t.nodeName) ? f.zoom = 1 : f.display = "inline-block")), n.overflow && (f.overflow = "hidden", ht.shrinkWrapBlocks() || h.always(function() {
                    f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
                }));
                for (r in e)
                    if (i = e[r], Me.exec(i)) {
                        if (delete e[r], s = s || "toggle" === i, i === (p ? "hide" : "show")) {
                            if ("show" !== i || !m || void 0 === m[r]) continue;
                            p = !0
                        }
                        d[r] = m && m[r] || ft.style(t, r)
                    } else u = void 0;
                if (ft.isEmptyObject(d)) "inline" === ("none" === u ? O(t.nodeName) : u) && (f.display = u);
                else {
                    m ? "hidden" in m && (p = m.hidden) : m = ft._data(t, "fxshow", {}), s && (m.hidden = !p), p ? ft(t).show() : h.done(function() {
                        ft(t).hide()
                    }), h.done(function() {
                        var e;
                    ...
                    for (r in d) o = W(p ? m[r] : 0, r, h), r in m || (m[r] = o.start, p && (o.end = o.start, o.start = "width" === r || "height" === r ? 1 : 0))
                }
            }
            ...
            function B(t, e, n) {
                var r, i, s = 0,
                    ...
                    l = function() {
                        if (i) return !1;
                        for (var e = Te || H(), n = Math.max(0, u.startTime + u.duration - e), r = n / u.duration || 0, s = 1 - r, o = 0, l = u.tweens.length; l > o; o++) u.tweens[o].run(s);
                ...
                for (I(c, u.opts.specialEasing); o > s; s++)
                    if (r = B.prefilters[s].call(u, t, c, u.opts)) return ft.isFunction(r.stop) && (ft._queueHooks(u.elem, u.opts.queue).stop = ft.proxy(r.stop, r)), r;
            ...
            function $(t, e, n, r) {
                function i(a) {
                    ...
                    return s[a] = !0, ft.each(t[a] || [], function(t, a) {
                        var u = a(e, n, r);
                        return "string" != typeof u || o || s[u] ? o ? !(l = u) : void 0 : (e.dataTypes.unshift(u), i(u), !1)
                    }), l
                }
                var s = {},
                    o = t === Ke;
            ...
            function X(t, e, n, r) {
                ...
                for (s = c.shift(); s;)
                    if (t.responseFields[s] && (n[t.responseFields[s]] = e), !l && r && t.dataFilter && (e = t.dataFilter(e, t.dataType)), l = s, s = c.shift())
                        if ("*" === s) s = l;
                        else if ("*" !== l && l !== s) {
                    if (o = u[l + " " + s] || u["* " + s], !o)
                        for (i in u)
                            if (a = i.split(" "), a[1] === s && (o = u[l + " " + a[0]] || u["* " + a[0]])) {
            ...
            ft.fn = ft.prototype = {
                ...
                var t, e, n, r, i, s, o = arguments[0] || {},
                    ...
                    l = arguments.length,
                    u = !1;
                for ("boolean" == typeof o && (u = o, o = arguments[a] || {}, a++), "object" == typeof o || ft.isFunction(o) || (o = {}), a === l && (o = this, a--); l > a; a++)
                    if (null != (i = arguments[a]))
                        for (r in i) t = o[r], n = i[r], o !== n && (u && n && (ft.isPlainObject(n) || (e = ft.isArray(n))) ? (e ? (e = !1, s = t && ft.isArray(t) ? t : []) : s = t && ft.isPlainObject(t) ? t : {}, o[r] = ft.extend(u, s, n)) : void 0 !== n && (o[r] = n));
                return o
            }, ft.extend({
            ...
            var vt = function(t) {
                function e(t, e, n, r) {
                    var i, s, o, a, l, u, h, f, p = e && e.ownerDocument,
                        m = e ? e.nodeType : 9;
                    if (n = n || [], "string" != typeof t || !t || 1 !== m && 9 !== m && 11 !== m) return n;
                    if (!r && ((e ? e.ownerDocument || e : W) !== E && j(e), e = e || E, Y)) {
                        if (11 !== m && (u = yt.exec(t)))
                            if (i = u[1]) {
                                if (9 === m) {
                                    if (!(o = e.getElementById(i))) return n;
                                    if (o.id === i) return n.push(o), n
                                } else if (p && (o = p.getElementById(i)) && H(e, o) && o.id === i) return n.push(o), n
                            } else {
                                if (u[2]) return K.apply(n, e.getElementsByTagName(t)), n;
                                if ((i = u[3]) && x.getElementsByClassName && e.getElementsByClassName) return K.apply(n, e.getElementsByClassName(i)), n
                            }
                        if (x.qsa && !z[t + " "] && (!P || !P.test(t))) {
                            if (1 !== m) p = e, f = t;
                            else if ("object" !== e.nodeName.toLowerCase()) {
                                for ((a = e.getAttribute("id")) ? a = a.replace(wt, "\\$&") : e.setAttribute("id", a = R), h = T(t), s = h.length, l = dt.test(a) ? "#" + a : "[id='" + a + "']"; s--;) h[s] = l + " " + d(h[s]);
                ...
                function f(t, e, n) {
                    ...
                    return e.first ? function(e, n, s) {
                        ...
                        if (o) {
                            ...
                            for (; e = e[r];)
                                if (1 === e.nodeType || i) {
                                    if (u = e[R] || (e[R] = {}), l = u[e.uniqueID] || (u[e.uniqueID] = {}), (a = l[r]) && a[0] === q && a[1] === s) return c[2] = a[2];
                                    if (l[r] = c, c[2] = t(e, n, o)) return !0
                                }
                    }
                }
                ...
                function g(t, e, n, r, i) {
                    for (var s, o = [], a = 0, l = t.length, u = null != e; l > a; a++)(s = t[a]) && (!n || n(s, r, i)) && (o.push(s), u && e.push(a));
                    return o
                }

                function y(t, e, n, i, s, o) {
                    return i && !i[R] && (i = y(i)), s && !s[R] && (s = y(s, o)), r(function(r, o, a, l) {
                        var u, c, h, d = [],
                            f = [],
                            p = o.length,
                            y = r || m(e || "*", a.nodeType ? [a] : a, []),
                            v = !t || !r && e ? y : g(y, d, t, a, l),
                            w = n ? s || (r ? t : p || i) ? [] : o : v;
                        if (n && n(v, w, a, l), i)
                            for (u = g(w, f), i(u, [], a, l), c = u.length; c--;)(h = u[c]) && (w[f[c]] = !(v[f[c]] = h));
                        if (r) {
                            if (s || t) {
                                if (s) {
                                ...
                                for (c = w.length; c--;)(h = w[c]) && (u = s ? tt(r, h) : d[c]) > -1 && (r[u] = !(o[u] = h))
                            }
                        } else w = g(w === o ? w.splice(p, w.length) : w), s ? s(null, o, w, l) : K.apply(o, w)
                    })
                }
                    ...
                    var i = n.length > 0,
                        ...
                        o = function(r, o, a, l, u) {
                            ...
                            for (u && (D = o === E || o || u); p !== x && null != (c = w[p]); p++) {
                                if (s && c) {
                                    for (h = 0, o || c.ownerDocument === E || (j(c), a = !Y); d = t[h++];)
                                        if (d(c, o || E, a)) {
                                            l.push(c);
                                            break
                                        }
                            ...
                            if (f += p, i && p !== f) {
                                for (h = 0; d = n[h++];) d(m, y, o, a);
                                if (r) {
                                    if (f > 0)
                                        for (; p--;) m[p] || y[p] || (y[p] = Z.call(l));
                                    y = g(y)
                                }
                                K.apply(l, y), u && !r && y.length > 0 && f + n.length > 1 && e.uniqueSort(l)
                            }
                            return u && (q = b, D = v), m
                        };
                    return i ? r(o) : o
                }
                var b, x, _, k, S, T, C, M, D, N, O, j, E, A, Y, P, L, F, H, R = "sizzle" + 1 * new Date,
                    W = t.document,
                    q = 0,
                    I = 0,
                    B = n(),
                ...
                try {
                    K.apply(X = Q.call(W.childNodes), W.childNodes), X[W.childNodes.length].nodeType
                } catch (kt) {
                    K = {
                ...
                x = e.support = {}, S = e.isXML = function(t) {
                    ...
                    return r !== E && 9 === r.nodeType && r.documentElement ? (E = r, A = E.documentElement, Y = !S(E), (n = E.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", _t, !1) : n.attachEvent && n.attachEvent("onunload", _t)), x.attributes = i(function(t) {
                        return t.className = "i", !t.getAttribute("className")
                    }), x.getElementsByTagName = i(function(t) {
                        return t.appendChild(E.createComment("")), !t.getElementsByTagName("*").length
                    }), x.getElementsByClassName = gt.test(E.getElementsByClassName), x.getById = i(function(t) {
                    ...
                    }, L = [], P = [], (x.qsa = gt.test(E.querySelectorAll)) && (i(function(t) {
                        ...
                        x.disconnectedMatch = F.call(t, "div"), F.call(t, "[s!='']:x"), L.push("!=", st)
                    }), P = P.length && new RegExp(P.join("|")), L = L.length && new RegExp(L.join("|")), e = gt.test(A.compareDocumentPosition), H = e || gt.test(A.contains) ? function(t, e) {
                        ...
                        return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === E || t.ownerDocument === W && H(W, t) ? -1 : e === E || e.ownerDocument === W && H(W, e) ? 1 : N ? tt(N, t) - tt(N, e) : 0 : 4 & n ? -1 : 1)
                    } : function(t, e) {
                        if (t === e) return O = !0, 0;
                        var n, r = 0,
                            i = t.parentNode,
                            ...
                            a = [t],
                            l = [e];
                        if (!i || !s) return t === E ? -1 : e === E ? 1 : i ? -1 : s ? 1 : N ? tt(N, t) - tt(N, e) : 0;
                        if (i === s) return o(t, e);
                    ...
                    if ((t.ownerDocument || t) !== E && j(t), n = n.replace(ct, "='$1']"), x.matchesSelector && Y && !z[n + " "] && (!L || !L.test(n)) && (!P || !P.test(n))) try {
                        var r = F.call(t, n);
                        if (r || x.disconnectedMatch || t.document && 11 !== t.document.nodeType) return r
                    } catch (i) {}
                    return e(n, E, null, [t]).length > 0
                }, e.contains = function(t, e) {
                    return (t.ownerDocument || t) !== E && j(t), H(t, e)
                }, e.attr = function(t, e) {
                    ...
                    var e, n = [],
                        r = 0,
                        i = 0;
                    if (O = !x.detectDuplicates, N = !x.sortStable && t.slice(0), t.sort($), O) {
                    ...
                    filter: {
                            ...
                            return 1 === r && 0 === i ? function(t) {
                                ...
                                if (g) {
                                    ...
                                    if (p = [o ? g.firstChild : g.lastChild], o && v) {
                                        for (d = g, h = d[R] || (d[R] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), u = c[t] || [], f = u[0] === q && u[1], w = f && u[2], d = f && g.childNodes[f]; d = ++f && d && d[m] || (w = f = 0) || p.pop();)
                                            if (1 === d.nodeType && ++w && d === e) {
                                                c[t] = [q, f, w];
                                                break
                                            }
                                    } else if (v && (d = e, h = d[R] || (d[R] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), u = c[t] || [], f = u[0] === q && u[1], w = f), w === !1)
                                        for (;
                                            (d = ++f && d && d[m] || (w = f = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) || !++w || (v && (h = d[R] || (d[R] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), c[t] = [q, w]), d !== e)););
                        ...
                        PSEUDO: function(t, n) {
                            ...
                            return s[R] ? s(n) : s.length > 1 ? (i = [t, t, "", n], _.setFilters.hasOwnProperty(t.toLowerCase()) ? r(function(t, e) {
                        ...
                        lang: r(function(t) {
                            return dt.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(bt, xt).toLowerCase(),
                                function(e) {
                                    var n;
                                    do
                                        if (n = Y ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang")) return n = n.toLowerCase(), n === t || 0 === n.indexOf(t + "-"); while ((e = e.parentNode) && 1 === e.nodeType);
                                    return !1
                                }
                        }),
                        target: function(e) {
                ...
                return h.prototype = _.filters = _.pseudos, _.setFilters = new h, T = e.tokenize = function(t, n) {
                    ...
                    for (a = t, l = [], u = _.preFilter; a;) {
                        (!r || (i = lt.exec(a))) && (i && (a = a.slice(i[0].length) || a), l.push(s = [])), r = !1, (i = ut.exec(a)) && (r = i.shift(), s.push({
                            value: r,
                            type: i[0].replace(at, " ")
                        }), a = a.slice(r.length));
                        for (o in _.filter) !(i = ft[o].exec(a)) || u[o] && !(i = u[o](i)) || (r = i.shift(), s.push({
                            value: r,
                            type: o,
                            matches: i
                        }), a = a.slice(r.length));
                    ...
                    var n, r = [],
                        ...
                        s = z[t + " "];
                    if (!s) {
                        for (e || (e = T(t)), n = e.length; n--;) s = v(e[n]), s[R] ? r.push(s) : i.push(s);
                        s = z(t, w(i, r)), s.selector = t
                    }
                    return s
                }, M = e.select = function(t, e, n, r) {
                    var i, s, o, a, l, u = "function" == typeof t && t,
                        h = !r && T(t = u.selector || t);
                    if (n = n || [], 1 === h.length) {
                        if (s = h[0] = h[0].slice(0), s.length > 2 && "ID" === (o = s[0]).type && x.getById && 9 === e.nodeType && Y && _.relative[s[1].type]) {
                            if (e = (_.find.ID(o.matches[0].replace(bt, xt), e) || [])[0], !e) return n;
                            u && (e = e.parentNode), t = t.slice(s.shift().value.length)
                        }
                        for (i = ft.needsContext.test(t) ? 0 : s.length; i-- && (o = s[i], !_.relative[a = o.type]);)
                            if ((l = _.find[a]) && (r = l(o.matches[0].replace(bt, xt), vt.test(s[0].type) && c(e.parentNode) || e))) {
                                if (s.splice(i, 1), t = r.length && d(s), !t) return K.apply(n, r), n;
                                break
                            }
                    }
                    return (u || C(t, h))(r, e, !Y, n, !e || vt.test(t) && c(e.parentNode) || e), n
                }, x.sortStable = R.split("").sort($).join("") === R, x.detectDuplicates = !!O, j(), x.sortDetached = i(function(t) {
            ...
            var St, Tt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
                Ct = ft.fn.init = function(t, e, n) {
                    ...
                    if (n = n || St, "string" == typeof t) {
                        ...
                        if (r[1]) {
                            if (e = e instanceof ft ? e[0] : e, ft.merge(this, ft.parseHTML(r[1], e && e.nodeType ? e.ownerDocument || e : rt, !0)), _t.test(r[1]) && ft.isPlainObject(e))
                                for (r in e) ft.isFunction(this[r]) ? this[r](e[r]) : this.attr(r, e[r]);
                            return this
                        }
                        if (i = rt.getElementById(r[2]), i && i.parentNode) {
                            if (i.id !== r[2]) return St.find(t);
            ...
            ft.fn.extend({
                ...
                ft.fn[t] = function(n, r) {
                    ...
                    return "Until" !== t.slice(-5) && (r = n), r && "string" == typeof r && (i = ft.filter(r, i)), this.length > 1 && (Dt[t] || (i = ft.uniqueSort(i)), Mt.test(t) && (i = i.reverse())), this.pushStack(i)
                }
            });
            var Nt = /\S+/g;
            ft.Callbacks = function(t) {
                ...
                when: function(t) {
                    ...
                    if (o > 1)
                        for (e = new Array(o), n = new Array(o), r = new Array(o); o > i; i++) s[i] && ft.isFunction(s[i].promise) ? s[i].promise().progress(u(i, n, e)).done(u(i, r, s)).fail(l.reject) : --a;
            ...
            ft.fn.ready = function(t) {
                ...
                ready: function(t) {
                    (t === !0 ? --ft.readyWait : ft.isReady) || (ft.isReady = !0, t !== !0 && --ft.readyWait > 0 || (Ot.resolveWith(rt, [ft]), ft.fn.triggerHandler && (ft(rt).triggerHandler("ready"), ft(rt).off("ready"))))
                }
            }), ft.ready.promise = function(e) {
                if (!Ot)
                    if (Ot = ft.Deferred(), "complete" === rt.readyState || "loading" !== rt.readyState && !rt.documentElement.doScroll) t.setTimeout(ft.ready);
            ...
            var jt;
            for (jt in ft(ht)) break;
            ht.ownFirst = "0" === jt, ht.inlineBlockNeedsLayout = !1, ft(function() {
                    var t, e, n, r;
            ...
            var Pt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
                ...
                Rt = function(t, e, n, r, i, s, o) {
                    ...
                    if ("object" === ft.type(n)) {
                        i = !0;
                        for (a in n) Rt(t, e, a, n[a], !0, s, o)
                    } else if (void 0 !== r && (i = !0, ft.isFunction(r) || (o = !0), u && (o ? (e.call(t, r), e = null) : (u = e, e = function(t, e, n) {
            ...
            ! function() {
                ...
                for (e in {
                        ...
                        change: !0,
                        focusin: !0
                    }) n = "on" + e, (ht[e] = n in t) || (r.setAttribute(n, "t"), ht[e] = r.attributes[n].expando === !1);
                r = null
            }();
            ...
            ft.event = {
                ...
                add: function(t, e, n, r, i) {
                    ...
                    if (g) {
                        for (n.handler && (l = n, n = l.handler, i = l.selector), n.guid || (n.guid = ft.guid++), (o = g.events) || (o = g.events = {}), (c = g.handle) || (c = g.handle = function(t) {
                                return "undefined" == typeof ft || t && ft.event.triggered === t.type ? void 0 : ft.event.dispatch.apply(c.elem, arguments)
                            }, c.elem = t), e = (e || "").match(Nt) || [""], a = e.length; a--;) s = Kt.exec(e[a]) || [], f = m = s[1], p = (s[2] || "").split(".").sort(), f && (u = ft.event.special[f] || {}, f = (i ? u.delegateType : u.bindType) || f, u = ft.event.special[f] || {}, h = ft.extend({
                            type: f,
                            origType: m,
                            data: r,
                            handler: n,
                            ...
                            namespace: p.join(".")
                        }, l), (d = o[f]) || (d = o[f] = [], d.delegateCount = 0, u.setup && u.setup.call(t, r, p, c) !== !1 || (t.addEventListener ? t.addEventListener(f, c, !1) : t.attachEvent && t.attachEvent("on" + f, c))), u.add && (u.add.call(t, h), h.handler.guid || (h.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, h) : d.push(h), ft.event.global[f] = !0);
                        t = null
                    }
                },
                remove: function(t, e, n, r, i) {
                    ...
                    if (g && (c = g.events)) {
                        for (e = (e || "").match(Nt) || [""], u = e.length; u--;)
                            if (a = Kt.exec(e[u]) || [], f = m = a[1], p = (a[2] || "").split(".").sort(), f) {
                                for (h = ft.event.special[f] || {}, f = (r ? h.delegateType : h.bindType) || f, d = c[f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = s = d.length; s--;) o = d[s], !i && m !== o.origType || n && n.guid !== o.guid || a && !a.test(o.namespace) || r && r !== o.selector && ("**" !== r || !o.selector) || (d.splice(s, 1), o.selector && d.delegateCount--, h.remove && h.remove.call(t, o));
                                l && !d.length && (h.teardown && h.teardown.call(t, p, g.handle) !== !1 || ft.removeEvent(t, f, g.handle), delete c[f])
                            } else
                                for (f in c) ft.event.remove(t, f + e[u], n, r, !0);
                        ft.isEmptyObject(c) && (delete g.handle, ft._removeData(t, "events"))
                    }
                },
                trigger: function(e, n, r, i) {
                    var s, o, a, l, u, c, h, d = [r || rt],
                        f = ct.call(e, "type") ? e.type : e,
                        p = ct.call(e, "namespace") ? e.namespace.split(".") : [];
                    if (a = c = r = r || rt, 3 !== r.nodeType && 8 !== r.nodeType && !Jt.test(f + ft.event.triggered) && (f.indexOf(".") > -1 && (p = f.split("."), f = p.shift(), p.sort()), o = f.indexOf(":") < 0 && "on" + f, e = e[ft.expando] ? e : new ft.Event(f, "object" == typeof e && e), e.isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), n = null == n ? [e] : ft.makeArray(n, [e]), u = ft.event.special[f] || {}, i || !u.trigger || u.trigger.apply(r, n) !== !1)) {
                        if (!i && !u.noBubble && !ft.isWindow(r)) {
                            for (l = u.delegateType || f, Jt.test(l + f) || (a = a.parentNode); a; a = a.parentNode) d.push(a), c = a;
                            c === (r.ownerDocument || rt) && d.push(c.defaultView || c.parentWindow || t)
                        }
                        for (h = 0;
                            (a = d[h++]) && !e.isPropagationStopped();) e.type = h > 1 ? l : u.bindType || f, s = (ft._data(a, "events") || {})[e.type] && ft._data(a, "handle"), s && s.apply(a, n), s = o && a[o], s && s.apply && Et(a) && (e.result = s.apply(a, n), e.result === !1 && e.preventDefault());
                        if (e.type = f, !i && !e.isDefaultPrevented() && (!u._default || u._default.apply(d.pop(), n) === !1) && Et(r) && o && r[f] && !ft.isWindow(r)) {
                            c = r[o], c && (r[o] = null), ft.event.triggered = f;
                            try {
                                r[f]()
                            } catch (m) {}
                            ft.event.triggered = void 0, c && (r[o] = c)
                        }
                        return e.result
                    }
                },
                ...
                fix: function(t) {
                    ...
                    var e, n, r, i = t.type,
                        s = t,
                        o = this.fixHooks[i];
                    for (o || (this.fixHooks[i] = o = Zt.test(i) ? this.mouseHooks : Xt.test(i) ? this.keyHooks : {}), r = o.props ? this.props.concat(o.props) : this.props, t = new ft.Event(s), e = r.length; e--;) n = r[e], t[n] = s[n];
            ...
            ft.extend({
                ...
                clone: function(t, e, n) {
                    ...
                    if (ht.html5Clone || ft.isXMLDoc(t) || !te.test("<" + t.nodeName + ">") ? s = t.cloneNode(!0) : (ae.innerHTML = t.outerHTML, ae.removeChild(s = ae.firstChild)), !(ht.noCloneEvent && ht.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ft.isXMLDoc(t)))
                        for (r = p(s), a = p(t), o = 0; null != (i = a[o]); ++o) r[o] && C(i, r[o]);
                    if (e)
                        if (n)
                            for (a = a || p(t), r = r || p(s), o = 0; null != (i = a[o]); o++) T(i, r[o]);
                        else T(t, s);
                    return r = p(s, "script"), r.length > 0 && m(r, !l && p(t, "script")), r = a = i = null, s
                },
                cleanData: function(t, e) {
                    for (var n, r, i, s, o = 0, a = ft.expando, l = ft.cache, u = ht.attributes, c = ft.event.special; null != (n = t[o]); o++)
                        if ((e || Et(n)) && (i = n[a], s = i && l[i])) {
                            if (s.events)
                                for (r in s.events) c[r] ? ft.event.remove(n, r) : ft.removeEvent(n, r, s.handle);
                            l[i] && (delete l[i], u || "undefined" == typeof n.removeAttribute ? n[a] = void 0 : n.removeAttribute(a), nt.push(i))
                        }
                }
            }), ft.fn.extend({
                domManip: M,
                ...
                html: function(t) {
                    return Rt(this, function(t) {
                        ...
                        if ("string" == typeof t && !ne.test(t) && (ht.htmlSerialize || !te.test(t)) && (ht.leadingWhitespace || !Bt.test(t)) && !zt[(qt.exec(t) || ["", ""])[1].toLowerCase()]) {
                            ...
                            try {
                                for (; r > n; n++) e = this[n] || {}, 1 === e.nodeType && (ft.cleanData(p(e, !1)), e.innerHTML = t);
                                e = 0
                            } catch (i) {}
                        }
            ...
            ! function() {
                function e() {
                    ...
                    h.appendChild(l), u.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", n = i = a = !1, r = o = !0, t.getComputedStyle && (c = t.getComputedStyle(u), n = "1%" !== (c || {}).top, a = "2px" === (c || {}).marginLeft, i = "4px" === (c || {
                        width: "4px"
                ...
                u.style && (u.style.cssText = "float:left;opacity:.5", ht.opacity = "0.5" === u.style.opacity, ht.cssFloat = !!u.style.cssFloat, u.style.backgroundClip = "content-box", u.cloneNode(!0).style.backgroundClip = "", ht.clearCloneStyle = "content-box" === u.style.backgroundClip, l = rt.createElement("div"), l.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", u.innerHTML = "", l.appendChild(u), ht.boxSizing = "" === u.style.boxSizing || "" === u.style.MozBoxSizing || "" === u.style.WebkitBoxSizing, ft.extend(ht, {
            ...
            t.getComputedStyle ? (pe = function(e) {
                ...
                return n = n || pe(t), o = n ? n.getPropertyValue(e) || n[e] : void 0, "" !== o && void 0 !== o || ft.contains(t.ownerDocument, t) || (o = ft.style(t, e)), n && !ht.pixelMarginRight() && he.test(o) && ce.test(e) && (r = a.width, i = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, o = n.width, a.width = r, a.minWidth = i, a.maxWidth = s), void 0 === o ? o : o + ""
            }) : fe.currentStyle && (pe = function(t) {
                return t.currentStyle
            }, me = function(t, e, n) {
                var r, i, s, o, a = t.style;
                return n = n || pe(t), o = n ? n[e] : void 0, null == o && a && a[e] && (o = a[e]), he.test(o) && !ge.test(e) && (r = a.left, i = t.runtimeStyle, s = i && i.left, s && (i.left = t.currentStyle.left), a.left = "fontSize" === e ? "1em" : o, o = a.pixelLeft + "px", a.left = r, s && (i.left = s)), void 0 === o ? o : o + "" || "auto"
            });
            var ye = /alpha\([^)]*\)/i,
                ve = /opacity\s*=\s*([^)]*)/i,
                we = /^(none|table(?!-c[ea]).+)/,
            ...
            ft.extend({
                ...
                style: function(t, e, n, r) {
                    if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                        ...
                        if (s = typeof n, "string" === s && (i = Lt.exec(n)) && i[1] && (n = d(t, e, i), s = "number"), null != n && n === n && ("number" === s && (n += i && i[3] || (ft.cssNumber[a] ? "" : "px")), ht.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(o && "set" in o && void 0 === (n = o.set(t, n, r))))) try {
                            l[e] = n
                        } catch (u) {}
                    }
                },
                css: function(t, e, n, r) {
                    var i, s, o, a = ft.camelCase(e);
                    return e = ft.cssProps[a] || (ft.cssProps[a] = E(a) || a), o = ft.cssHooks[e] || ft.cssHooks[a], o && "get" in o && (s = o.get(t, !0, n)), void 0 === s && (s = me(t, e, r)), "normal" === s && e in _e && (s = _e[e]), "" === n || n ? (i = parseFloat(s), n === !0 || isFinite(i) ? i || 0 : s) : s
                }
                ...
                ft.cssHooks[t + e] = {
                    expand: function(n) {
                        for (var r = 0, i = {}, s = "string" == typeof n ? n.split(" ") : [n]; 4 > r; r++) i[t + Ft[r] + e] = s[r] || s[r - 2] || s[0];
                        return i
                    }
                ...
                css: function(t, e) {
                    return Rt(this, function(t, e, n) {
                        var r, i, s = {},
                            o = 0;
                        if (ft.isArray(e)) {
                            for (r = pe(t), i = e.length; i > o; o++) s[e[o]] = ft.css(t, e[o], !1, r);
                            return s
                        }
            ...
            ft.Animation = ft.extend(B, {
                    ...
                    tweener: function(t, e) {
                        ...
                        for (var n, r = 0, i = t.length; i > r; r++) n = t[r], B.tweeners[n] = B.tweeners[n] || [], B.tweeners[n].unshift(e)
                    },
                    prefilters: [q],
                    ...
                    stop: function(t, e, n) {
                        ...
                        return "string" != typeof t && (n = e, e = t, t = void 0), e && t !== !1 && this.queue(t || "fx", []), this.each(function() {
                            ...
                            if (i) o[i] && o[i].stop && r(o[i]);
                                ...
                                for (i in o) o[i] && o[i].stop && De.test(i) && r(o[i]);
                    ...
                    select: {
                        get: function(t) {
                            for (var e, n, r = t.options, i = t.selectedIndex, s = "select-one" === t.type || 0 > i, o = s ? null : [], a = s ? i + 1 : r.length, l = 0 > i ? a : s ? i : 0; a > l; l++)
                                if (n = r[l], (n.selected || l === i) && (ht.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !ft.nodeName(n.parentNode, "optgroup"))) {
            ...
            var je, Ee, Ae = ft.expr.attrHandle,
                Ye = /^(?:checked|selected)$/i,
                Pe = ht.getSetAttribute,
                Le = ht.input;
            ft.fn.extend({
                attr: function(t, e) {
                ...
                attr: function(t, e, n) {
                    var r, i, s = t.nodeType;
                    if (3 !== s && 8 !== s && 2 !== s) return "undefined" == typeof t.getAttribute ? ft.prop(t, e, n) : (1 === s && ft.isXMLDoc(t) || (e = e.toLowerCase(), i = ft.attrHooks[e] || (ft.expr.match.bool.test(e) ? Ee : je)), void 0 !== n ? null === n ? void ft.removeAttr(t, e) : i && "set" in i && void 0 !== (r = i.set(t, n, e)) ? r : (t.setAttribute(e, n + ""), n) : i && "get" in i && null !== (r = i.get(t, e)) ? r : (r = ft.find.attr(t, e), null == r ? void 0 : r))
                },
                attrHooks: {
                    type: {
                        set: function(t, e) {
                ...
                removeAttr: function(t, e) {
                    var n, r, i = 0,
                        s = e && e.match(Nt);
                    if (s && 1 === t.nodeType)
                        for (; n = s[i++];) r = ft.propFix[n] || n, ft.expr.match.bool.test(n) ? Le && Pe || !Ye.test(n) ? t[r] = !1 : t[ft.camelCase("default-" + n)] = t[r] = !1 : ft.attr(t, n, ""), t.removeAttribute(Pe ? n : r)
                }
            }), Ee = {
                set: function(t, e, n) {
                    return e === !1 ? ft.removeAttr(t, n) : Le && Pe || !Ye.test(n) ? t.setAttribute(!Pe && ft.propFix[n] || n, n) : t[ft.camelCase("default-" + n)] = t[n] = !0, n
                }
            }, ft.each(ft.expr.match.bool.source.match(/\w+/g), function(t, e) {
                var n = Ae[e] || ft.find.attr;
                Le && Pe || !Ye.test(e) ? Ae[e] = function(t, e, r) {
                    var i, s;
                    return r || (s = Ae[e], Ae[e] = i, i = null != n(t, e, r) ? e.toLowerCase() : null, Ae[e] = s), i
                } : Ae[e] = function(t, e, n) {
            ...
            ft.fn.extend({
                addClass: function(t) {
                    ...
                    if ("string" == typeof t && t)
                        for (e = t.match(Nt) || []; n = this[l++];)
                            if (i = U(n), r = 1 === n.nodeType && (" " + i + " ").replace(Re, " ")) {
                ...
                toggleClass: function(t, e) {
                    ...
                    return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ft.isFunction(t) ? this.each(function(n) {
                        ...
                        var e, r, i, s;
                        if ("string" === n)
                            for (r = 0, i = ft(this), s = t.match(Nt) || []; e = s[r++];) i.hasClass(e) ? i.removeClass(e) : i.addClass(e);
                ...
                hasClass: function(t) {
                    var e, n, r = 0;
                    for (e = " " + t + " "; n = this[r++];)
                        if (1 === n.nodeType && (" " + U(n) + " ").replace(Re, " ").indexOf(e) > -1) return !0;
                    return !1
                }
            ...
            ft.extend({
                ...
                ajax: function(e, n) {
                    function r(e, n, r, i) {
                        var s, h, v, w, x, k = n;
                        2 !== b && (b = 2, l && t.clearTimeout(l), c = void 0, a = i || "", _.readyState = e > 0 ? 4 : 0, s = e >= 200 && 300 > e || 304 === e, r && (w = G(d, _, r)), w = X(d, w, _, s), s ? (d.ifModified && (x = _.getResponseHeader("Last-Modified"), x && (ft.lastModified[o] = x), x = _.getResponseHeader("etag"), x && (ft.etag[o] = x)), 204 === e || "HEAD" === d.type ? k = "nocontent" : 304 === e ? k = "notmodified" : (k = w.state, h = w.data, v = w.error, s = !v)) : (v = k, (e || !k) && (k = "error", 0 > e && (e = 0))), _.status = e, _.statusText = (n || k) + "", s ? m.resolveWith(f, [h, k, _]) : m.rejectWith(f, [_, k, v]), _.statusCode(y), y = void 0, u && p.trigger(s ? "ajaxSuccess" : "ajaxError", [_, d, s ? h : v]), g.fireWith(f, [_, k]), u && (p.trigger("ajaxComplete", [_, d]), --ft.active || ft.event.trigger("ajaxStop")))
                    }
                    "object" == typeof e && (n = e, e = void 0), n = n || {};
                    var i, s, o, a, l, u, c, h, d = ft.ajaxSetup({}, n),
                        f = d.context || d,
                    ...
                    if (m.promise(_).complete = g.add, _.success = _.done, _.error = _.fail, d.url = ((e || d.url || tn) + "").replace(Ue, "").replace(Xe, en[1] + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = ft.trim(d.dataType || "*").toLowerCase().match(Nt) || [""], null == d.crossDomain && (i = Ze.exec(d.url.toLowerCase()), d.crossDomain = !(!i || i[1] === en[1] && i[2] === en[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (en[3] || ("http:" === en[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ft.param(d.data, d.traditional)), $(Je, d, n, _), 2 === b) return _;
                    u = ft.event && d.global, u && 0 === ft.active++ && ft.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Ge.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (Ie.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = ze.test(o) ? o.replace(ze, "$1_=" + qe++) : o + (Ie.test(o) ? "&" : "?") + "_=" + qe++)), d.ifModified && (ft.lastModified[o] && _.setRequestHeader("If-Modified-Since", ft.lastModified[o]), ft.etag[o] && _.setRequestHeader("If-None-Match", ft.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || n.contentType) && _.setRequestHeader("Content-Type", d.contentType), _.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Qe + "; q=0.01" : "") : d.accepts["*"]);
                    for (s in d.headers) _.setRequestHeader(s, d.headers[s]);
                        ...
                        send: function(r, i) {
                            ...
                            o.send(e.hasContent && e.data || null), n = function(t, r) {
                                ...
                                if (n && (r || 4 === o.readyState))
                                    if (delete un[a], n = void 0, o.onreadystatechange = ft.noop, r) 4 !== o.readyState && o.abort();
                                    else {
            ...
            ft.ajaxSetup({
                ...
                return a || "jsonp" === e.dataTypes[0] ? (i = e.jsonpCallback = ft.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(dn, "$1" + i) : e.jsonp !== !1 && (e.url += (Ie.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
                    return o || ft.error(i + " was not called"), o[0]
                }, e.dataTypes[0] = "json", s = t[i], t[i] = function() {
                    o = arguments
                }, r.always(function() {
                    void 0 === s ? ft(t).removeProp(i) : t[i] = s, e[i] && (e.jsonpCallback = n.jsonpCallback, hn.push(i)), o && ft.isFunction(s) && s(o[0]), o = s = void 0
                }), "script") : void 0
            ...
            ft.fn.load = function(t, e, n) {
                ...
                setOffset: function(t, e, n) {
                    var r, i, s, o, a, l, u, c = ft.css(t, "position"),
                        h = ft(t),
                        d = {};
                ...
                offset: function(t) {
                    ...
                    var e, n, r = {
                        ...
                        i = this[0],
                        s = i && i.ownerDocument;
                    if (s) return e = s.documentElement, ft.contains(e, i) ? ("undefined" != typeof i.getBoundingClientRect && (r = i.getBoundingClientRect()),
                        n = et(s), {
                ...
                ft.cssHooks[e] = j(ht.pixelPosition, function(t, n) {
                    return n ? (n = me(t, e), he.test(n) ? ft(t).position()[e] + "px" : n) : void 0
                })
            }), ft.each({
                Height: "height",
                Width: "width"
    ...
    2: [function(t, e, n) {
        ! function(t, r) {
            ...
            function v(t, e) {
                var n, r, i;
                if (a(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), a(e._i) || (t._i = e._i), a(e._f) || (t._f = e._f), a(e._l) || (t._l = e._l), a(e._strict) || (t._strict = e._strict), a(e._tzm) || (t._tzm = e._tzm), a(e._isUTC) || (t._isUTC = e._isUTC), a(e._offset) || (t._offset = e._offset), a(e._pf) || (t._pf = m(e)), a(e._locale) || (t._locale = e._locale), jr.length > 0)
                    for (n = 0; n < jr.length; n++) r = jr[n], i = e[r], a(i) || (t[r] = i);
                return t
            }

            function w(t) {
                v(this, t), this._d = new Date(null != t._d ? t._d.getTime() : NaN), this.isValid() || (this._d = new Date(NaN)), Er === !1 && (Er = !0, n.updateOffset(this), Er = !1)
            }
            ...
            function k(t, e, n) {
                var r, i = Math.min(t.length, e.length),
                    ...
                    o = 0;
                for (r = 0; i > r; r++)(n && t[r] !== e[r] || !n && _(t[r]) !== _(e[r])) && o++;
                return o + s
            }
            ...
            function C(t, e) {
                null != n.deprecationHandler && n.deprecationHandler(t, e), Ar[t] || (S(e), Ar[t] = !0)
            }
            ...
            function N(t, e) {
                var n, r = d({}, t);
                for (n in e) h(e, n) && (s(t[n]) && s(e[n]) ? (r[n] = {}, d(r[n], t[n]), d(r[n], e[n])) : null != e[n] ? r[n] = e[n] : delete r[n]);
                for (n in t) h(t, n) && !h(e, n) && s(t[n]) && (r[n] = d({}, r[n]));
                return r
            }
            ...
            function R(t) {
                var e, n, r = {};
                for (n in t) h(t, n) && (e = H(n), e && (r[e] = t[n]));
                return r
            }
            ...
            function z(t) {
                ...
                for (e = 0, n = r.length; n > e; e++) $r[r[e]] ? r[e] = $r[r[e]] : r[e] = U(r[e]);
                return function(e) {
                    var i, s = "";
                    for (i = 0; n > i; i++) s += M(r[i]) ? r[i].call(e, t) : r[i];
                    return s
                }
            }

            function $(t, e) {
                return t.isValid() ? (e = V(e, t.localeData()), zr[e] = zr[e] || z(e), zr[e](t)) : t.localeData().invalidDate()
            }
            ...
            function it(t, e) {
                return function(r) {
                    return null != r ? (ot(this, t, r), n.updateOffset(this, e), this) : st(this, t)
                }
            }
            ...
            function at(t) {
                return t = H(t), M(this[t]) ? this[t]() : this
            }

            function lt(t, e) {
                if ("object" == typeof t) {
                    t = R(t);
                    for (var n = q(t), r = 0; r < n.length; r++) this[n[r].unit](t[n[r].unit])
                } else if (t = H(t), M(this[t])) return this[t](e);
                return this
            }
            ...
            function ft(t, e, n) {
                ...
                return n ? "MMM" === e ? (i = xi.call(this._shortMonthsParse, o), -1 !== i ? i : null) : (i = xi.call(this._longMonthsParse, o), -1 !== i ? i : null) : "MMM" === e ? (i = xi.call(this._shortMonthsParse, o), -1 !== i ? i : (i = xi.call(this._longMonthsParse, o), -1 !== i ? i : null)) : (i = xi.call(this._longMonthsParse, o), -1 !== i ? i : (i = xi.call(this._shortMonthsParse, o), -1 !== i ? i : null))
            }
            ...
            function gt(t) {
                return null != t ? (mt(this, t), n.updateOffset(this, !0), this) : st(this, "Month")
            }
            ...
            function vt(t) {
                return this._monthsParseExact ? (h(this, "_monthsRegex") || bt.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex) : (h(this, "_monthsShortRegex") || (this._monthsShortRegex = Ci), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex)
            }

            function wt(t) {
                return this._monthsParseExact ? (h(this, "_monthsRegex") || bt.call(this), t ? this._monthsStrictRegex : this._monthsRegex) : (h(this, "_monthsRegex") || (this._monthsRegex = Mi), this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex)
            }
            ...
            function bt() {
                ...
                var e, n, r = [],
                    i = [],
                    s = [];
                for (e = 0; 12 > e; e++) n = f([2e3, e]), r.push(this.monthsShort(n, "")), i.push(this.months(n, "")), s.push(this.months(n, "")), s.push(this.monthsShort(n, ""));
                for (r.sort(t), i.sort(t), s.sort(t), e = 0; 12 > e; e++) r[e] = J(r[e]), i[e] = J(i[e]);
                for (e = 0; 24 > e; e++) s[e] = J(s[e]);
            ...
            function St(t, e, n, r, i) {
                var s, o, a = (7 + n - r) % 7,
                    l = kt(t, r, i),
                    u = 1 + 7 * (e - 1) + a + l;
                return 0 >= u ? (s = t - 1, o = et(s) + u) : u > et(t) ? (s = t + 1, o = u - et(t)) : (s = t, o = u), {
                    year: s,
                    dayOfYear: o
                }
            }
            ...
            function Tt(t, e, n) {
                var r, i, s = kt(t.year(), e, n),
                    o = Math.floor((t.dayOfYear() - s - 1) / 7) + 1;
                return 1 > o ? (i = t.year() - 1, r = o + Ct(i, e, n)) : o > Ct(t.year(), e, n) ? (r = o - Ct(t.year(), e, n), i = t.year() + 1) : (i = t.year(), r = o), {
                    week: r,
                    year: i
                }
            }
            ...
            function Ht(t, e, n) {
                ...
                for (this._weekdaysParse || (this._weekdaysParse = [], this._minWeekdaysParse = [], this._shortWeekdaysParse = [], this._fullWeekdaysParse = []), r = 0; 7 > r; r++) {
                    if (i = f([2e3, 1]).day(r), n && !this._fullWeekdaysParse[r] && (this._fullWeekdaysParse[r] = new RegExp("^" + this.weekdays(i, "").replace(".", "\\.?") + "$", "i"), this._shortWeekdaysParse[r] = new RegExp("^" + this.weekdaysShort(i, "").replace(".", "\\.?") + "$", "i"), this._minWeekdaysParse[r] = new RegExp("^" + this.weekdaysMin(i, "").replace(".", "\\.?") + "$", "i")), this._weekdaysParse[r] || (s = "^" + this.weekdays(i, "") + "|^" + this.weekdaysShort(i, "") + "|^" + this.weekdaysMin(i, ""), this._weekdaysParse[r] = new RegExp(s.replace(".", ""), "i")), n && "dddd" === e && this._fullWeekdaysParse[r].test(t)) return r;
            ...
            function It(t) {
                return this._weekdaysParseExact ? (h(this, "_weekdaysRegex") || zt.call(this), t ? this._weekdaysStrictRegex : this._weekdaysRegex) : (h(this, "_weekdaysRegex") || (this._weekdaysRegex = Ei), this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex)
            }

            function Bt(t) {
                return this._weekdaysParseExact ? (h(this, "_weekdaysRegex") || zt.call(this), t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (h(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Ai), this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
            }

            function Ut(t) {
                return this._weekdaysParseExact ? (h(this, "_weekdaysRegex") || zt.call(this), t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (h(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Yi), this._weekdaysMinStrictRegex && t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
            }
            ...
            function zt() {
                ...
                var e, n, r, i, s, o = [],
                    ...
                    l = [],
                    u = [];
                for (e = 0; 7 > e; e++) n = f([2e3, 1]).day(e), r = this.weekdaysMin(n, ""), i = this.weekdaysShort(n, ""), s = this.weekdays(n, ""), o.push(r), a.push(i), l.push(s), u.push(r), u.push(i), u.push(s);
                for (o.sort(t), a.sort(t), l.sort(t), u.sort(t), e = 0; 7 > e; e++) a[e] = J(a[e]), l[e] = J(l[e]), u[e] = J(u[e]);
            ...
            function Qt(t) {
                for (var e, n, r, i, s = 0; s < t.length;) {
                    for (i = Kt(t[s]).split("-"), e = i.length, n = Kt(t[s + 1]), n = n ? n.split("-") : null; e > 0;) {
                        if (r = te(i.slice(0, e).join("-"))) return r;
            ...
            function te(n) {
                var r = null;
                if (!Ri[n] && "undefined" != typeof e && e && e.exports) try {
                    r = Pi._abbr;
                    var i = t;
                    i("./locale/" + n), ee(r)
                } catch (s) {}
            ...
            function ee(t, e) {
                var n;
                return t && (n = a(e) ? ie(t) : ne(t, e), n ? Pi = n : "undefined" != typeof console && console.warn && console.warn("Locale " + t + " not found. Did you forget to load it?")), Pi._abbr
            }

            function ne(t, e) {
                if (null !== e) {
                    var n, r = Hi;
                    if (e.abbr = t, null != Ri[t]) C("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), r = Ri[t]._config;
                    else if (null != e.parentLocale)
                        if (null != Ri[e.parentLocale]) r = Ri[e.parentLocale]._config;
                        else {
                            if (n = te(e.parentLocale), null == n) return Wi[e.parentLocale] || (Wi[e.parentLocale] = []), Wi[e.parentLocale].push({
                                name: t,
                                config: e
                            }), null;
                            r = n._config
                        }
                    return Ri[t] = new O(N(r, e)), Wi[t] && Wi[t].forEach(function(t) {
                        ne(t.name, t.config)
                    }), ee(t), Ri[t]
                }
            ...
            function re(t, e) {
                if (null != e) {
                    var n, r, i = Hi;
                    r = te(t), null != r && (i = r._config), e = N(i, e), n = new O(e), n.parentLocale = Ri[t], Ri[t] = n, ee(t)
            ...
            function oe(t) {
                var e, n = t._a;
                return n && -2 === m(t).overflow && (e = n[fi] < 0 || n[fi] > 11 ? fi : n[pi] < 1 || n[pi] > ct(n[di], n[fi]) ? pi : n[mi] < 0 || n[mi] > 24 || 24 === n[mi] && (0 !== n[gi] || 0 !== n[yi] || 0 !== n[vi]) ? mi : n[gi] < 0 || n[gi] > 59 ? gi : n[yi] < 0 || n[yi] > 59 ? yi : n[vi] < 0 || n[vi] > 999 ? vi : -1, m(t)._overflowDayOfYear && (di > e || e > pi) && (e = pi), m(t)._overflowWeeks && -1 === e && (e = wi), m(t)._overflowWeekday && -1 === e && (e = bi), m(t).overflow = e), t
            }
            ...
            function ue(t) {
                var e, n, r, i, s, o = [];
                if (!t._d) {
                    for (r = le(t), t._w && null == t._a[pi] && null == t._a[fi] && ce(t), null != t._dayOfYear && (s = ae(t._a[di], r[di]), (t._dayOfYear > et(s) || 0 === t._dayOfYear) && (m(t)._overflowDayOfYear = !0), n = _t(s, 0, t._dayOfYear), t._a[fi] = n.getUTCMonth(), t._a[pi] = n.getUTCDate()), e = 0; 3 > e && null == t._a[e]; ++e) t._a[e] = o[e] = r[e];
                    for (; 7 > e; e++) t._a[e] = o[e] = null == t._a[e] ? 2 === e ? 1 : 0 : t._a[e];
                    24 === t._a[mi] && 0 === t._a[gi] && 0 === t._a[yi] && 0 === t._a[vi] && (t._nextDay = !0, t._a[mi] = 0), t._d = (t._useUTC ? _t : xt).apply(null, o), i = t._useUTC ? t._d.getUTCDay() : t._d.getDay(), null != t._tzm && t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), t._nextDay && (t._a[mi] = 24), t._w && "undefined" != typeof t._w.d && t._w.d !== i && (m(t).weekdayMismatch = !0)
                }
            }

            function ce(t) {
                var e, n, r, i, s, o, a, l;
                if (e = t._w, null != e.GG || null != e.W || null != e.E) s = 1, o = 4, n = ae(e.GG, t._a[di], Tt(Me(), 1, 4).year), r = ae(e.W, 1), i = ae(e.E, 1), (1 > i || i > 7) && (l = !0);
                else {
                    s = t._locale._week.dow, o = t._locale._week.doy;
                    var u = Tt(Me(), s, o);
                    n = ae(e.gg, t._a[di], u.year), r = ae(e.w, u.week), null != e.d ? (i = e.d, (0 > i || i > 6) && (l = !0)) : null != e.e ? (i = e.e + s, (e.e < 0 || e.e > 6) && (l = !0)) : i = s
                }
                1 > r || r > Ct(n, s, o) ? m(t)._overflowWeeks = !0 : null != l ? m(t)._overflowWeekday = !0 : (a = St(n, r, i, s, o), t._a[di] = a.year, t._dayOfYear = a.dayOfYear)
            }

            function he(t) {
                var e, n, r, i, s, o, a = t._i,
                    l = qi.exec(a) || Ii.exec(a);
                if (l) {
                    for (m(t).iso = !0, e = 0, n = Ui.length; n > e; e++)
                        if (Ui[e][1].exec(l[1])) {
                            i = Ui[e][0], r = Ui[e][2] !== !1;
                            break
                        }
                    ...
                    if (l[4]) {
                        if (!Bi.exec(l[4])) return void(t._isValid = !1);
                        o = "Z"
                    }
                    t._f = i + (s || "") + (o || ""), we(t)
                } else t._isValid = !1
            ...
            function ye(t) {
                ...
                if (e) {
                    ...
                    if (!me(e[1], n, t)) return;
                    t._a = n, t._tzm = ge(e[8], e[9], e[10]), t._d = _t.apply(null, t._a), t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), m(t).rfc2822 = !0
                } else t._isValid = !1
            }

            function ve(t) {
                var e = $i.exec(t._i);
                return null !== e ? void(t._d = new Date(+e[1])) : (he(t), void(t._isValid === !1 && (delete t._isValid, ye(t), t._isValid === !1 && (delete t._isValid, n.createFromInputFallback(t)))))
            }

            function we(t) {
                if (t._f === n.ISO_8601) return void he(t);
                if (t._f === n.RFC_2822) return void ye(t);
                t._a = [], m(t).empty = !0;
                var e, r, i, s, o, a = "" + t._i,
                    l = a.length,
                    u = 0;
                for (i = V(t._f, t._locale).match(Br) || [], e = 0; e < i.length; e++) s = i[e], r = (a.match(X(s, t)) || [])[0], r && (o = a.substr(0, a.indexOf(r)), o.length > 0 && m(t).unusedInput.push(o), a = a.slice(a.indexOf(r) + r.length), u += r.length), $r[s] ? (r ? m(t).empty = !1 : m(t).unusedTokens.push(s), tt(s, r, t)) : t._strict && !r && m(t).unusedTokens.push(s);
                m(t).charsLeftOver = l - u, a.length > 0 && m(t).unusedInput.push(a), t._a[mi] <= 12 && m(t).bigHour === !0 && t._a[mi] > 0 && (m(t).bigHour = void 0), m(t).parsedDateParts = t._a.slice(0), m(t).meridiem = t._meridiem, t._a[mi] = be(t._locale, t._a[mi], t._meridiem), ue(t), oe(t)
            }
            ...
            function xe(t) {
                ...
                for (i = 0; i < t._f.length; i++) s = 0, e = v({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[i], we(e), g(e) && (s += m(e).charsLeftOver, s += 10 * m(e).unusedTokens.length, m(e).score = s, (null == r || r > s) && (r = s, n = e));
                d(t, n || e)
            }
            ...
            function Se(t) {
                var e = t._i,
                    n = t._f;
                return t._locale = t._locale || ie(t._l), null === e || void 0 === n && "" === e ? y({
                    nullInput: !0
                }) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), b(e) ? new w(oe(e)) : (u(e) ? t._d = e : i(n) ? xe(t) : n ? we(t) : Te(t), g(t) || (t._d = null), t))
            }
            ...
            function Ce(t, e, n, r, a) {
                var l = {};
                return (n === !0 || n === !1) && (r = n, n = void 0), (s(t) && o(t) || i(t) && 0 === t.length) && (t = void 0), l._isAMomentObject = !0, l._useUTC = l._isUTC = a, l._l = n, l._i = t, l._f = e, l._strict = r, ke(l)
            }
            ...
            function je(t) {
                for (var e in t)
                    if (-1 === xi.call(Ki, e) || null != t[e] && isNaN(t[e])) return !1;
            ...
            function Ye(t) {
                var e = R(t),
                    ...
                    u = e.second || 0,
                    c = e.millisecond || 0;
                this._isValid = je(e), this._milliseconds = +c + 1e3 * u + 6e4 * l + 1e3 * a * 60 * 60, this._days = +o + 7 * s, this._months = +i + 3 * r + 12 * n, this._data = {}, this._locale = ie(), this._bubble()
            }
            ...
            function Re(t, e) {
                var r, i;
                return e._isUTC ? (r = e.clone(), i = (b(t) || u(t) ? t.valueOf() : Me(t).valueOf()) - r.valueOf(), r._d.setTime(r._d.valueOf() + i), n.updateOffset(r, !1), r) : Me(t).local()
            }
            ...
            function qe(t, e, r) {
                ...
                if (null != t) {
                    if ("string" == typeof t) {
                        if (t = He(ai, t), null === t) return this
                    } else Math.abs(t) < 16 && !r && (t = 60 * t);
                    return !this._isUTC && e && (i = We(this)), this._offset = t, this._isUTC = !0, null != i && this.add(i, "m"), s !== t && (!e || this._changeInProgress ? rn(this, Ke(t - s, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, n.updateOffset(this, !0), this._changeInProgress = null)), this
                }
            ...
            function $e(t) {
                return this.isValid() ? (t = t ? Me(t).utcOffset() : 0, (this.utcOffset() - t) % 60 === 0) : !1
            }
            ...
            function Ke(t, e) {
                ...
                return Pe(t) ? s = {
                    ...
                    d: t._days,
                    M: t._months
                } : l(t) ? (s = {}, e ? s[e] = t : s.milliseconds = t) : (o = ts.exec(t)) ? (n = "-" === o[1] ? -1 : 1, s = {
                    y: 0,
                    d: _(o[pi]) * n,
                    h: _(o[mi]) * n,
                    m: _(o[gi]) * n,
                    ...
                    m: Qe(o[7], n),
                    s: Qe(o[8], n)
                }) : null == s ? s = {} : "object" == typeof s && ("from" in s || "to" in s) && (i = en(Me(s.from), Me(s.to)), s = {}, s.ms = i.milliseconds, s.M = i.months), r = new Ye(s), Pe(t) && h(t, "_locale") && (r._locale = t._locale), r
            }
            ...
            function en(t, e) {
                var n;
                return t.isValid() && e.isValid() ? (e = Re(e, t), t.isBefore(e) ? n = tn(t, e) : (n = tn(e, t), n.milliseconds = -n.milliseconds, n.months = -n.months), n) : {
                    milliseconds: 0,
                    months: 0
                }
            }
            ...
            function nn(t, e) {
                return function(n, r) {
                    var i, s;
                    return null === r || isNaN(+r) || (C(e, "moment()." + e + "(period, number) is deprecated. Please use moment()." + e + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), s = n, n = r, r = s), n = "string" == typeof n ? +n : n, i = Ke(n, r), rn(this, i, t), this
                }
            }
            ...
            function rn(t, e, r, i) {
                var s = e._milliseconds,
                    o = Le(e._days),
                    a = Le(e._months);
                t.isValid() && (i = null == i ? !0 : i, a && mt(t, st(t, "Month") + a * r), o && ot(t, "Date", st(t, "Date") + o * r), s && t._d.setTime(t._d.valueOf() + s * r), i && n.updateOffset(t, o || a))
            }
            ...
            function ln(t, e) {
                var n = b(t) ? t : Me(t);
                return this.isValid() && n.isValid() ? (e = H(a(e) ? "millisecond" : e), "millisecond" === e ? this.valueOf() > n.valueOf() : n.valueOf() < this.clone().startOf(e).valueOf()) : !1
            }

            function un(t, e) {
                var n = b(t) ? t : Me(t);
                return this.isValid() && n.isValid() ? (e = H(a(e) ? "millisecond" : e), "millisecond" === e ? this.valueOf() < n.valueOf() : this.clone().endOf(e).valueOf() < n.valueOf()) : !1
            }
            ...
            function hn(t, e) {
                var n, r = b(t) ? t : Me(t);
                return this.isValid() && r.isValid() ? (e = H(e || "millisecond"), "millisecond" === e ? this.valueOf() === r.valueOf() : (n = r.valueOf(), this.clone().startOf(e).valueOf() <= n && n <= this.clone().endOf(e).valueOf())) : !1
            }
            ...
            function pn(t, e, n) {
                ...
                if (r = Re(t, this), !r.isValid()) return NaN;
            ...
            function mn(t, e) {
                ...
                return 0 > e - s ? (n = t.clone().add(i - 1, "months"), r = (e - s) / (s - n)) : (n = t.clone().add(i + 1, "months"), r = (e - s) / (n - s)), -(i + r) || 0
            }
            ...
            function Bn(t, e, n, r, i) {
                var s;
                return null == t ? Tt(this, r, i).year : (s = Ct(t, r, i), e > s && (e = s), Un.call(this, t, e, n, r, i))
            }
            ...
            function tr(t, e, n) {
                ...
                var r, i = [];
                for (r = 0; 12 > r; r++) i[r] = Qn(t, r, n, "month");
                return i
            }
            ...
            function er(t, e, n, r) {
                ...
                var i = ie(),
                    s = t ? i._week.dow : 0;
                if (null != n) return Qn(e, (n + s) % 7, r, "day");
                var o, a = [];
                for (o = 0; 7 > o; o++) a[o] = Qn(e, (o + s) % 7, r, "day");
                return a
            }
            ...
            function dr() {
                var t, e, n, r, i, s = this._milliseconds,
                    o = this._days,
                    a = this._months,
                    l = this._data;
                return s >= 0 && o >= 0 && a >= 0 || 0 >= s && 0 >= o && 0 >= a || (s += 864e5 * hr(pr(a) + o), o = 0, a = 0), l.milliseconds = s % 1e3, t = x(s / 1e3), l.seconds = t % 60, e = x(t / 60), l.minutes = e % 60, n = x(e / 60), l.hours = n % 24, o += x(n / 24), i = x(fr(o)), a += i, o -= hr(pr(i)), r = x(a / 12), a %= 12, l.days = o, l.months = a, l.years = r, this
            }
            ...
            function mr(t) {
                ...
                if (t = H(t), "month" === t || "year" === t) return e = this._days + r / 864e5, n = this._months + fr(e), "month" === t ? n : n / 12;
            ...
            function Sr(t) {
                return void 0 === t ? Ds : "function" == typeof t ? (Ds = t, !0) : !1
            }

            function Tr(t, e) {
                return void 0 === Ns[t] ? !1 : void 0 === e ? Ns[t] : (Ns[t] = e, "s" === t && (Ns.ss = e - 1), !0)
            }
            ...
            function Dr() {
                if (!this.isValid()) return this.localeData().invalidDate();
                var t, e, n, r = Os(this._milliseconds) / 1e3,
                    i = Os(this._days),
                    s = Os(this._months);
                t = x(r / 60), e = x(t / 60), r %= 60, t %= 60, n = x(s / 12), s %= 12;
                var o = n,
                    a = s,
                    l = i,
                    u = e,
            ...
            }), B(0, ["YYYY", 4], 0, "year"), B(0, ["YYYYY", 5], 0, "year"), B(0, ["YYYYYY", 6, !0], 0, "year"), F("year", "y"), W("year", 1), G("Y", si), G("YY", Kr, Gr), G("YYYY", ni, Zr), G("YYYYY", ri, Jr), G("YYYYYY", ri, Jr), K(["YYYYY", "YYYYYY"], di), K("YYYY", function(t, e) {
            ...
            }), F("month", "M"), W("month", 8), G("M", Kr), G("MM", Kr, Gr), G("MMM", function(t, e) {
            ...
            var ki = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
                ...
                Ci = ui,
                Mi = ui;
            B("w", ["ww", 2], "wo", "week"), B("W", ["WW", 2], "Wo", "isoWeek"), F("week", "w"), F("isoWeek", "W"), W("week", 5), W("isoWeek", 5), G("w", Kr), G("ww", Kr, Gr), G("W", Kr), G("WW", Kr, Gr), Q(["w", "ww", "W", "WW"], function(t, e, n, r) {
                e[r.substr(0, 1)] = _(t)
            });
            var Di = {
                dow: 0,
            ...
            }), B("e", 0, 0, "weekday"), B("E", 0, 0, "isoWeekday"), F("day", "d"), F("weekday", "e"), F("isoWeekday", "E"), W("day", 11), W("weekday", 11), W("isoWeekday", 11), G("d", Kr), G("e", Kr), G("E", Kr), G("dd", function(t, e) {
            ...
            var Ni = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
                ...
                Ai = ui,
                Yi = ui;
            B("H", ["HH", 2], 0, "hour"), B("h", ["hh", 2], 0, $t), B("k", ["kk", 2], 0, Vt), B("hmm", 0, 0, function() {
            ...
            }), Gt("a", !0), Gt("A", !1), F("hour", "h"), W("hour", 13), G("a", Xt), G("A", Xt), G("H", Kr), G("h", Kr), G("k", Kr), G("HH", Kr, Gr), G("hh", Kr, Gr), G("kk", Kr, Gr), G("hmm", Qr), G("hmmss", ti), G("Hmm", Qr), G("Hmmss", ti), K(["H", "HH"], mi), K(["k", "kk"], function(t, e, n) {
                var r = _(t);
                e[mi] = 24 === r ? 0 : r
            }), K(["a", "A"], function(t, e, n) {
                n._isPm = n._locale.isPM(t), n._meridiem = t
            }), K(["h", "hh"], function(t, e, n) {
                e[mi] = _(t), m(n).bigHour = !0
            }), K("hmm", function(t, e, n) {
                var r = t.length - 2;
                e[mi] = _(t.substr(0, r)), e[gi] = _(t.substr(r)), m(n).bigHour = !0
            }), K("hmmss", function(t, e, n) {
                var r = t.length - 4,
                    i = t.length - 2;
                e[mi] = _(t.substr(0, r)), e[gi] = _(t.substr(r, 2)), e[yi] = _(t.substr(i)), m(n).bigHour = !0
            }), K("Hmm", function(t, e, n) {
                var r = t.length - 2;
                e[mi] = _(t.substr(0, r)), e[gi] = _(t.substr(r))
            }), K("Hmmss", function(t, e, n) {
                var r = t.length - 4,
                    i = t.length - 2;
                e[mi] = _(t.substr(0, r)), e[gi] = _(t.substr(r, 2)), e[yi] = _(t.substr(i))
            });
            var Pi, Li = /[ap]\.?m?\.?/i,
                Fi = it("Hours", !0),
                Hi = {
            ...
            Fe("Z", ":"), Fe("ZZ", ""), G("Z", ai), G("ZZ", ai), K(["Z", "ZZ"], function(t, e, n) {
                n._useUTC = !0, n._tzm = He(ai, t)
            });
            var Qi = /([\+\-]|\d\d)/gi;
            n.updateOffset = function() {};
            var ts = /^(\-|\+)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/,
                es = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;
            Ke.fn = Ye.prototype, Ke.invalid = Ae;
            var ns = nn(1, "add"),
                rs = nn(-1, "subtract");
            ...
            }), Hn("gggg", "weekYear"), Hn("ggggg", "weekYear"), Hn("GGGG", "isoWeekYear"), Hn("GGGGG", "isoWeekYear"), F("weekYear", "gg"), F("isoWeekYear", "GG"), W("weekYear", 1), W("isoWeekYear", 1), G("G", si), G("g", si), G("GG", Kr, Gr), G("gg", Kr, Gr), G("GGGG", ni, Zr), G("gggg", ni, Zr), G("GGGGG", ri, Jr), G("ggggg", ri, Jr), Q(["gggg", "ggggg", "GGGG", "GGGGG"], function(t, e, n, r) {
                e[r.substr(0, 2)] = _(t)
            }), Q(["gg", "GG"], function(t, e, r, i) {
                e[i] = n.parseTwoDigitYear(t)
            }), B("Q", 0, "Qo", "quarter"), F("quarter", "Q"), W("quarter", 7), G("Q", Vr), K("Q", function(t, e) {
                e[fi] = 3 * (_(t) - 1)
            }), B("D", ["DD", 2], "Do", "date"), F("date", "D"), W("date", 9), G("D", Kr), G("DD", Kr, Gr), G("Do", function(t, e) {
                return t ? e._dayOfMonthOrdinalParse || e._ordinalParse : e._dayOfMonthOrdinalParseLenient
            }), K(["D", "DD"], pi), K("Do", function(t, e) {
                e[pi] = _(t.match(Kr)[0])
            });
            var ss = it("Date", !0);
            B("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), F("dayOfYear", "DDD"), W("dayOfYear", 4), G("DDD", ei), G("DDDD", Xr), K(["DDD", "DDDD"], function(t, e, n) {
                n._dayOfYear = _(t)
            }), B("m", ["mm", 2], 0, "minute"), F("minute", "m"), W("minute", 14), G("m", Kr), G("mm", Kr, Gr), K(["m", "mm"], gi);
            var os = it("Minutes", !1);
            B("s", ["ss", 2], 0, "second"), F("second", "s"), W("second", 15), G("s", Kr), G("ss", Kr, Gr), K(["s", "ss"], yi);
            var as = it("Seconds", !1);
            B("S", 0, 0, function() {
            ...
            }), n.lang = T("moment.lang is deprecated. Use moment.locale instead.", ee), n.langData = T("moment.langData is deprecated. Use moment.localeData instead.", ie);
            var ds = Math.abs,
                fs = yr("ms"),
                ps = yr("s"),
                ms = yr("m"),
                ...
                Os = Math.abs,
                js = Ye.prototype;
            return js.isValid = Ee, js.abs = ar, js.add = ur, js.subtract = cr, js.as = mr, js.asMilliseconds = fs, js.asSeconds = ps, js.asMinutes = ms, js.asHours = gs, js.asDays = ys, js.asWeeks = vs, js.asMonths = ws, js.asYears = bs, js.valueOf = gr, js._bubble = dr, js.clone = vr, js.get = wr, js.milliseconds = xs, js.seconds = _s, js.minutes = ks, js.hours = Ss, js.days = Ts, js.weeks = xr, js.months = Cs, js.years = Ms, js.humanize = Cr, js.toISOString = Dr, js.toString = Dr, js.toJSON = Dr, js.locale = Sn, js.localeData = Tn, js.toIsoString = T("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Dr), js.lang = is, B("X", 0, 0, "unix"), B("x", 0, 0, "valueOf"), G("x", si), G("X", li), K("X", function(t, e, n) {
                n._d = new Date(1e3 * parseFloat(t, 10))
            }), K("x", function(t, e, n) {
                n._d = new Date(_(t))
            }), n.version = "2.22.2", r(Me), n.fn = cs, n.min = Ne, n.max = Oe, n.now = Ji, n.utc = f, n.unix = Zn, n.months = nr, n.isDate = u, n.locale = ee, n.invalid = y, n.duration = Ke, n.isMoment = b, n.weekdays = ir, n.parseZone = Jn, n.localeData = ie, n.isDuration = Pe, n.monthsShort = rr, n.weekdaysMin = or, n.defineLocale = ne, n.updateLocale = re, n.locales = se, n.weekdaysShort = sr, n.normalizeUnits = H, n.relativeTimeRounding = Sr, n.relativeTimeThreshold = Tr, n.calendarFormat = sn, n.prototype = cs, n.HTML5_FMT = {
    ...
    3: [function(t, e, n) {
        ...
        function a() {
            g && p && (g = !1, p.length ? m = p.concat(m) : y = -1, m.length && l())
        }
        ...
        f.nextTick = function(t) {
            ...
            m.push(new u(t, e)), 1 !== m.length || g || s(l)
        ...
        (function(t) {
            ! function(r) {
                ...
                function o(t, e) {
                    var n = t.split("@"),
                        r = "";
                    n.length > 1 && (r = n[0] + "@", t = n[1]), t = t.replace(E, ".");
                    var i = t.split("."),
                        o = s(i, e).join(".");
                    return r + o
                }
                ...
                function a(t) {
                    for (var e, n, r = [], i = 0, s = t.length; s > i;) e = t.charCodeAt(i++), e >= 55296 && 56319 >= e && s > i ? (n = t.charCodeAt(i++), 56320 == (64512 & n) ? r.push(((1023 & e) << 10) + (1023 & n) + 65536) : (r.push(e), i--)) : r.push(e);
                    return r
                }
                ...
                function h(t, e, n) {
                    var r = 0;
                    for (t = n ? P(t / C) : t >> 1, t += P(t / e); t > Y * S >> 1; r += _) t = P(t / Y);
                    return P(r + (Y + 1) * t / (t + T))
                }

                function d(t) {
                    var e, n, r, s, o, a, c, d, f, p, m = [],
                        g = t.length,
                        y = 0,
                        v = D,
                        w = M;
                    for (n = t.lastIndexOf(N), 0 > n && (n = 0), r = 0; n > r; ++r) t.charCodeAt(r) >= 128 && i("not-basic"), m.push(t.charCodeAt(r));
                    for (s = n > 0 ? n + 1 : 0; g > s;) {
                        for (o = y, a = 1, c = _; s >= g && i("invalid-input"), d = u(t.charCodeAt(s++)), (d >= _ || d > P((x - y) / a)) && i("overflow"), y += d * a, f = w >= c ? k : c >= w + S ? S : c - w, !(f > d); c += _) p = _ - f, a > P(x / p) && i("overflow"), a *= p;
                        e = m.length + 1, w = h(y - o, e, 0 == o), P(y / e) > x - v && i("overflow"), v += P(y / e), y %= e, m.splice(y++, 0, v)
                    }
                    return l(m)
                }
                ...
                function f(t) {
                    ...
                    for (t = a(t), g = t.length, e = D, n = 0, o = M, l = 0; g > l; ++l) m = t[l], 128 > m && b.push(L(m));
                    for (r = s = b.length, s && b.push(N); g > r;) {
                        for (u = x, l = 0; g > l; ++l) m = t[l], m >= e && u > m && (u = m);
                        for (y = r + 1, u - e > P((x - n) / y) && i("overflow"), n += (u - e) * y, e = u, l = 0; g > l; ++l)
                            if (m = t[l], e > m && ++n > x && i("overflow"), m == e) {
                                for (d = n, f = _; p = o >= f ? k : f >= o + S ? S : f - o, !(p > d); f += _) w = d - p, v = _ - p, b.push(L(c(p + w % v, 0))), d = P(w / v);
                                b.push(L(c(d, 0))), o = h(n, y, r == s), n = 0, ++r
                            }++n, ++e
                    }
                    return b.join("")
                }
        ...
        e.exports = function(t, e, n, s) {
            ...
            for (var c = 0; u > c; ++c) {
                var h, d, f, p, m = t[c].replace(a, "%20"),
                    g = m.indexOf(n);
                g >= 0 ? (h = m.substr(0, g), d = m.substr(g + 1)) : (h = m, d = ""), f = decodeURIComponent(h), p = decodeURIComponent(d), r(o, f) ? i(o[f]) ? o[f].push(p) : o[f] = [o[f], p] : o[f] = p
            }
            return o
        };
    ...
    8: [function(t, e, n) {
        (function(t) {
            ! function() {
                ...
                "undefined" == typeof n || n.nodeType ? r._ = g : ("undefined" != typeof e && !e.nodeType && e.exports && (n = e.exports = g), n._ = g), g.VERSION = "1.9.1";
                ...
                var D = function(t) {
                    var e = function(e, n, r, i) {
                        var s = !M(e) && g.keys(e),
                            o = (s || e).length,
                            a = t > 0 ? 0 : o - 1;
                        for (i || (r = e[s ? s[a] : a], a += t); a >= 0 && o > a; a += t) {
                            var l = s ? s[a] : a;
                            r = n(r, e[l], l, e)
                        }
                        return r
                ...
                g.reduce = g.foldl = g.inject = D(1), g.reduceRight = g.foldr = D(-1), g.find = g.detect = function(t, e, n) {
                    var r = M(t) ? g.findIndex : g.findKey,
                        i = r(t, e, n);
                    return void 0 !== i && -1 !== i ? t[i] : void 0
                }, g.filter = g.select = function(t, e, n) {
                    var r = [];
                    return e = w(e, n), g.each(t, function(t, n, i) {
                        e(t, n, i) && r.push(t)
                    }), r
                    ...
                    return M(t) || (t = g.values(t)), ("number" != typeof n || r) && (n = 0), g.indexOf(t, e, n) >= 0
                }, g.invoke = b(function(t, e, n) {
                    var r, i;
                    return g.isFunction(e) ? i = e : g.isArray(e) && (r = e.slice(0, -1), e = e[e.length - 1]), g.map(t, function(t) {
                        var s = i;
                        if (!s) {
                            if (r && r.length && (t = S(t, r)), null == t) return void 0;
                            s = t[e]
                        }
                    ...
                    if (null == e || "number" == typeof e && "object" != typeof t[0] && null != t) {
                        t = M(t) ? t : g.values(t);
                        for (var a = 0, l = t.length; l > a; a++) r = t[a], null != r && r > s && (s = r)
                    ...
                    if (null == e || "number" == typeof e && "object" != typeof t[0] && null != t) {
                        t = M(t) ? t : g.values(t);
                        for (var a = 0, l = t.length; l > a; a++) r = t[a], null != r && s > r && (s = r)
                    } else e = w(e, n), g.each(t, function(t, n, r) {
                    ...
                    if (null == e || n) return M(t) || (t = g.values(t)), t[g.random(t.length - 1)];
                    ...
                    var r = 0;
                    return e = w(e, n), g.pluck(g.map(t, function(t, n, i) {
                        return {
                            value: t,
                            index: r++,
                            criteria: e(t, n, i)
                ...
                var N = function(t, e) {
                    return function(n, r, i) {
                        ...
                        return r = w(r, i), g.each(n, function(e, i) {
                            var o = r(e, i, n);
                            t(s, e, o)
                        }), s
                    }
                ...
                var j = function(t, e, n, r) {
                    ...
                    for (var i = r.length, s = 0, o = C(t); o > s; s++) {
                        ...
                        if (M(a) && (g.isArray(a) || g.isArguments(a)))
                            if (e)
                                for (var l = 0, u = a.length; u > l;) r[i++] = a[l++];
                            else j(a, e, n, r), i = r.length;
                        else n || (r[i++] = a)
                    }
                    return r
                };
                g.flatten = function(t, e) {
                    ...
                    for (var i = [], s = [], o = 0, a = C(t); a > o; o++) {
                        var l = t[o],
                            u = n ? n(l, o, t) : l;
                        e && !n ? (o && s === u || i.push(l), s = u) : n ? g.contains(s, u) || (s.push(u), i.push(l)) : g.contains(i, l) || i.push(l)
                    }
                    return i
                    ...
                    for (var e = t && g.max(t, C).length || 0, n = Array(e), r = 0; e > r; r++) n[r] = g.pluck(t, r);
                    return n
                }, g.zip = b(g.unzip), g.object = function(t, e) {
                ...
                g.findIndex = E(1), g.findLastIndex = E(-1), g.sortedIndex = function(t, e, n, r) {
                    n = w(n, r, 1);
                ...
                var A = function(t, e, n) {
                    return function(r, i, s) {
                        ...
                        if (i !== i) return s = e(u.call(r, o, a), g.isNaN), s >= 0 ? s + o : -1;
                        for (s = t > 0 ? o : a - 1; s >= 0 && a > s; s += t)
                            if (r[s] === i) return s;
                        return -1
                    }
                };
                g.indexOf = A(1, g.findIndex, g.sortedIndex), g.lastIndexOf = A(-1, g.findLastIndex), g.range = function(t, e, n) {
                    null == e && (e = t || 0, t = 0), n || (n = t > e ? -1 : 1);
                    for (var r = Math.max(Math.ceil((e - t) / n), 0), i = Array(r), s = 0; r > s; s++, t += n) i[s] = t;
                    return i
                }, g.chunk = function(t, e) {
                    if (null == e || 1 > e) return [];
                    for (var n = [], r = 0, i = t.length; i > r;) n.push(u.call(t, r, r += e));
                    return n
                };
                ...
                g.bind = b(function(t, e, n) {
                    ...
                    var n = g.partial.placeholder,
                        r = function() {
                            for (var i = 0, s = e.length, o = Array(s), a = 0; s > a; a++) o[a] = e[a] === n ? arguments[i++] : e[a];
                            for (; i < arguments.length;) o.push(arguments[i++]);
                            return Y(t, r, this, this, o)
                        };
                    return r
                }), g.partial.placeholder = g, g.bindAll = b(function(t, e) {
                    e = j(e, !1, !1);
                    var n = e.length;
                    ...
                    var n = function(r) {
                        ...
                        return k(i, s) || (i[s] = t.apply(this, arguments)), i[s]
                    };
                    return n.cache = {}, n
                    ...
                    var l = function() {
                        ...
                        u = function() {
                            ...
                            a || n.leading !== !1 || (a = u);
                            var c = e - (u - a);
                            return i = this, s = arguments, 0 >= c || c > e ? (r && (clearTimeout(r), r = null), a = u, o = t.apply(i, s), r || (i = s = null)) : r || n.trailing === !1 || (r = setTimeout(l, c)), o
                        };
                ...
                var P = !{
                    ...
                    F = function(t, e) {
                        var n = L.length,
                            ...
                            s = "constructor";
                        for (k(t, s) && !g.contains(e, s) && e.push(s); n--;) s = L[n], s in t && t[s] !== i[s] && !g.contains(e, s) && e.push(s)
                    };
                g.keys = function(t) {
                    if (!g.isObject(t)) return [];
                    if (f) return f(t);
                ...
                var H = function(t, e) {
                    return function(n) {
                        ...
                        if (e && (n = Object(n)), 2 > r || null == n) return n;
                        for (var i = 1; r > i; i++)
                ...
                g.extend = H(g.allKeys), g.extendOwn = g.assign = H(g.keys), g.findKey = function(t, e, n) {
                    e = w(e, n);
                ...
                g.pick = b(function(t, e) {
                    var n = {},
                        r = e[0];
                    if (null == t) return n;
                    g.isFunction(r) ? (e.length > 1 && (r = v(r, e[1])), e = g.allKeys(t)) : (r = R, e = j(e, !1, !1), t = Object(t));
                    ...
                    var n, r = e[0];
                    return g.isFunction(r) ? (r = g.negate(r), e.length > 1 && (n = e[1])) : (e = g.map(j(e, !1, !1), String), r = function(t, n) {
                        return !g.contains(e, n)
                    }), g.pick(t, r, n)
                }), g.defaults = H(g.allKeys, !0), g.create = function(t, e) {
                    var n = x(t);
                ...
                W = function(t, e, n, r) {
                    ...
                    if (!s) {
                        ...
                        var o = t.constructor,
                            l = e.constructor;
                        if (o !== l && !(g.isFunction(o) && o instanceof o && g.isFunction(l) && l instanceof l) && "constructor" in t && "constructor" in e) return !1
                    }
                    n = n || [], r = r || [];
                    ...
                    if (n.push(t), r.push(e), s) {
                        ...
                        var h, d = g.keys(t);
                        if (u = d.length, g.keys(e).length !== u) return !1;
                        for (; u--;)
                            if (h = d[u], !k(e, h) || !W(t[h], e[h], n, r)) return !1
                    }
                ...
                g.escape = z(B), g.unescape = z(U), g.result = function(t, e, n) {
                    g.isArray(e) || (e = [e]);
                    var r = e.length;
                    if (!r) return g.isFunction(n) ? n.call(t) : n;
                    for (var i = 0; r > i; i++) {
                        var s = null == t ? void 0 : t[e[i]];
                        void 0 === s && (s = n, i = r), t = g.isFunction(s) ? s.call(t) : s
                    }
                    return t
                };
                var $ = 0;
                ...
                g.template = function(t, e, n) {
                    ...
                    t.replace(r, function(e, n, r, o, a) {
                        return s += t.slice(i, a).replace(X, Z), i = a + e.length, n ? s += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? s += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : o && (s += "';\n" + o + "\n__p+='"), e
    ...
    9: [function(t, e, n) {
        ...
        var l = t("punycode"),
            u = t("./util");
        n.parse = i, n.resolve = o, n.resolveObject = a, n.format = s, n.Url = r;
        var c = /^([a-z0-9.+-]+:)/i,
            h = /:[0-9]*$/,
            d = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,
            f = ["<", ">", '"', "`", " ", "\r", "\n", "	"],
        ...
        r.prototype.parse = function(t, e, n) {
            ...
            if (a = a.trim(), !n && 1 === t.split("#").length) {
                var h = d.exec(a);
                if (h) return this.path = a, this.href = a, this.pathname = h[1], h[2] ? (this.search = h[2], e ? this.query = S.parse(this.search.substr(1)) : this.query = this.search.substr(1)) : e && (this.search = "", this.query = {}), this
            }
            var f = c.exec(a);
            if (f) {
                f = f[0];
            ...
            if (n || f || a.match(/^\/\/[^@\/]+@[^@\/]+/)) {
                var T = "//" === a.substr(0, 2);
                !T || f && _[f] || (a = a.substr(2), this.slashes = !0)
            }
            if (!_[f] && (T || f && !k[f])) {
                for (var C = -1, M = 0; M < y.length; M++) {
                    var D = a.indexOf(y[M]); - 1 !== D && (-1 === C || C > D) && (C = D)
                }
                var N, O;
                O = -1 === C ? a.lastIndexOf("@") : a.lastIndexOf("@", C), -1 !== O && (N = a.slice(0, O), a = a.slice(O + 1), this.auth = decodeURIComponent(N)), C = -1;
                for (var M = 0; M < g.length; M++) {
                    var D = a.indexOf(g[M]); - 1 !== D && (-1 === C || C > D) && (C = D)
                ...
                if (!j)
                    for (var E = this.hostname.split(/\./), M = 0, A = E.length; A > M; M++) {
                        var Y = E[M];
                        if (Y && !Y.match(w)) {
                            for (var P = "", L = 0, F = Y.length; F > L; L++) P += Y.charCodeAt(L) > 127 ? "x" : Y[L];
                            if (!P.match(w)) {
                                var H = E.slice(0, M),
                                    R = E.slice(M + 1),
                                    W = Y.match(b);
                                W && (H.push(W[1]), R.unshift(W[2])), R.length && (a = "/" + R.join(".") + a), this.hostname = H.join(".");
                                break
                            }
                        }
                    }
                this.hostname.length > v ? this.hostname = "" : this.hostname = this.hostname.toLowerCase(), j || (this.hostname = l.toASCII(this.hostname));
                var q = this.port ? ":" + this.port : "",
                    I = this.hostname || "";
                this.host = I + q, this.href += this.host, j && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== a[0] && (a = "/" + a))
            }
            if (!x[p])
            ...
            var $ = a.indexOf("?");
            if (-1 !== $ ? (this.search = a.substr($), this.query = a.substr($ + 1), e && (this.query = S.parse(this.query)), a = a.slice(0, $)) : e && (this.search = "", this.query = {}), a && (this.pathname = a), k[p] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
                var q = this.pathname || "",
                    V = this.search || "";
                this.path = q + V
            }
            ...
            var e = this.protocol || "",
                ...
                i = !1,
                s = "";
            this.host ? i = t + this.host : this.hostname && (i = t + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (i += ":" + this.port)), this.query && u.isObject(this.query) && Object.keys(this.query).length && (s = S.stringify(this.query));
            var o = this.search || s && "?" + s || "";
            return e && ":" !== e.substr(-1) && (e += ":"), this.slashes || (!e || k[e]) && i !== !1 ? (i = "//" + (i || ""), n && "/" !== n.charAt(0) && (n = "/" + n)) : i || (i = ""), r && "#" !== r.charAt(0) && (r = "#" + r), o && "?" !== o.charAt(0) && (o = "?" + o), n = n.replace(/[?#]/g, function(t) {
            ...
            if (t.protocol && t.protocol !== n.protocol) {
                ...
                if (n.protocol = t.protocol, t.host || _[t.protocol]) n.pathname = t.pathname;
                else {
            ...
            if (S && (n.hostname = "", n.port = null, n.host && ("" === x[0] ? x[0] = n.host : x.unshift(n.host)), n.host = "", t.protocol && (t.hostname = null, t.port = null, t.host && ("" === p[0] ? p[0] = t.host : p.unshift(t.host)), t.host = null), w = w && ("" === p[0] || "" === x[0])), v) n.host = t.host || "" === t.host ? t.host : n.host, n.hostname = t.hostname || "" === t.hostname ? t.hostname : n.hostname, n.search = t.search, n.query = t.query, x = p;
            else if (p.length) x || (x = []), x.pop(), x = x.concat(p), n.search = t.search, n.query = t.query;
            ...
            for (var C = x.slice(-1)[0], M = (n.host || t.host || x.length > 1) && ("." === C || ".." === C) || "" === C, D = 0, N = x.length; N >= 0; N--) C = x[N], "." === C ? x.splice(N, 1) : ".." === C ? (x.splice(N, 1), D++) : D && (x.splice(N, 1), D--);
            if (!w && !b)
                for (; D--; D) x.unshift("..");
            ...
            return w = w || n.host && x.length, w && !O && x.unshift(""), x.length ? n.pathname = x.join("/") : (n.pathname = null, n.path = null), u.isNull(n.pathname) && u.isNull(n.search) || (n.path = (n.pathname ? n.pathname : "") + (n.search ? n.search : "")), n.auth = t.auth || n.auth, n.slashes = n.slashes || t.slashes, n.href = n.format(), n
    ...
    11: [function(t, e, n) {
        function r(t, e, n) {
            var r = i.parse(t, !0);
            return r.query.utm_source = window.location.hostname, r.query.utm_medium = e, r.query.utm_campaign = n, delete r.search, i.format(r)
        }
        var i = t("url");
        e.exports = {
            setMediumCampaign: r
    ...
    13: [function(t, e, n) {
        (function(n) {
            function r(t) {
                ...
                d(e, 36e5, u.bind(this.processChart, this)), f.register(n, this.processSpot.bind(this)), f.subscribe(n), f.subscribe("source:widget-chart"), d(r, 36e5, this.processBlockchain.bind(this))
            }
            ...
            var l = t("jquery"),
                ...
                y = t("./analytics"),
                v = t("./util");
            r.prototype = Object.create(h.prototype), r.prototype.constructor = r, r.prototype.stylesLoaded = function() {
                ...
                if (this.styles) {
                    ...
                    l(".btcwdgt-body", this.el).attr("style", r), l("canvas", this.el).attr("style", r).css("width", t).css("height", n), this.chart.canvas.c.width = t * w, this.chart.canvas.c.height = n * w, this.chart.canvas.i.width = t * w, this.chart.canvas.i.height = n * w, this.chart.canvas.c.getContext("2d").scale(w, w), this.chart.canvas.i.getContext("2d").scale(w, w), this.chart.w = t, this.chart.h = n, this.calculate(), this.redraw();
                    var i = NaN;
                    isNaN(this.last.unix) ? this.data.length > 0 && (i = this.data[0][0]) : i = this.last.unix, isNaN(i) || (l(".date", this.el).html(c.unix(i).format("lll")), l(".date", this.el).width() > l(".date-wrap", this.el).width() && l(".date", this.el).html(c.unix(i).format("l")))
                }
                ...
                if (t.clearRect(0, 0, this.chart.w, this.chart.h), !(this.data.length <= 0)) {
                    ...
                    for (var m = 0; m < v.length; m++) i(t, 0, v[m]), s(t, this.chart.w, v[m]);
                    ...
                    t.strokeStyle = this.colors.grid, t.beginPath();
                    for (var m = 0; m < v.length; m++) i(t, v[m], 0), s(t, v[m], this.chart.h - this.chart.fpad);
                ...
                var r = NaN,
                    i = NaN;
                this.data.length > 0 && (i = this.data[0][0], r = this.data[0][1]), isNaN(this.last.price) || (i = this.last.time, r = this.last.price), isNaN(r) || (l("h2 span:last-child", this.el).html(r.toFixed(2)), l(".date", this.el).html(c.unix(i).format("lll")), l(".date", this.el).width() > l(".date-wrap", this.el).width() && l(".date", this.el).html(c.unix(i).format("l")))
            }, r.prototype.interact = function(t) {
                var e = a(t),
                    n = this.chart.canvas.i.getContext("2d"),
                    r = Math.round((this.chart.w - e.x) / this.chart.dx);
                if (n.clearRect(0, 0, this.chart.w, this.chart.h), !(0 > r || r >= (isNaN(this.last.price) ? this.data.length : this.data.length + 1))) {
                    var u = 5,
                        h = 6,
                        d = NaN,
                        f = NaN;
                    isNaN(this.last.price) ? (f = this.data[r][0], d = this.data[r][1]) : 0 == r ? (f = this.last.time,
                        d = this.last.price) : (f = this.data[r - 1][0], d = this.data[r - 1][1]), n.fillStyle = this.colors.fg;
                    var p = this.barToPxX(r),
                        m = this.priceToPxY(d);
                    n.beginPath(), p > u + h + 1 && (i(n, 0, m - u), s(n, u, m), s(n, 0, m + u), s(n, 0, m - u)), p < this.chart.w - (u + h + 1) && (i(n, this.chart.w, m - u), s(n, this.chart.w - u, m), s(n, this.chart.w, m + u), s(n, this.chart.w, m - u)), n.fill(), n.strokeStyle = this.colors.crosshair, n.lineWidth = 1, n.beginPath(), i(n, p, 0), s(n, p, m - h - 3), i(n, p, m + h + 3), s(n, p, this.chart.h), n.stroke(), n.strokeStyle = this.colors.label, n.lineWidth = 2, n.beginPath(), i(n, p + h, m), o(n, p, m, h), n.stroke(), l("h2 span:last-child", this.el).html(d.toFixed(2));
                ...
                if (this.styles) {
                    ...
                    if (this.data.length > 0 && (e = this.data[0][0], t = this.data[0][1]), isNaN(this.last.price) || (e = this.last.time, t = this.last.price), !isNaN(t) && !isNaN(e)) {
                        ...
                        var r = 100 * (t / this.data[0][1] - 1),
                            i = t - this.data[0][1];
                        l(".changes .pct", this.el).html(Math.abs(r).toFixed(1) + "%"), l(".changes .amt", this.el).html("$" + Math.abs(i).toFixed(2)), l(".arrow", this.el).removeClass("up down"), l(".changes", this.el).removeClass("up down"), i > 0 ? (l(".arrow", this.el).addClass("up"), l(".changes", this.el).addClass("up")) : 0 > i && (l(".arrow", this.el).addClass("down"), l(".changes", this.el).addClass("down"));
                        for (var s = t, o = t, a = 0; a < this.data.length; a++) {
                            var u = this.data[a][1];
                            u > s && (s = u), o > u && (o = u)
                        }
                        l(".high", this.el).html("$" + s.toFixed(2)), l(".low", this.el).html("$" + o.toFixed(2))
                    }
    ...
    16: [function(t, e, n) {
        ...
        r.prototype.addCallback = function(t) {
            ...
            this.poll(), setInterval(o.bind(this.poll, this), this.period)
            ...
            s.ajax({
                ...
                a.log("Done. " + (Date.now() - t) + "ms"), o.each(this.cb, function(t) {
                    try {
                        t(e)
                    } catch (n) {}
                })
    ...
    17: [function(t, e, n) {
        (function(n) {
            function r(t) {
                o.call(this, t), l.log("Create ForumWidget"), this.build(), this.el.addClass(this.postBuildClasses.join(" ")), a(u + "forum.json", 6e5, s.bind(this.processFeed, this))
            }
            var i = t("jquery"),
                s = t("underscore"),
                o = t("./widget"),
                ...
                u = n.env.BASE,
                c = t("./analytics");
            r.prototype = Object.create(o.prototype), r.prototype.constructor = r, r.prototype.build = function() {
                ...
                for (var e = [], n = 0, r = 0; r < t.length && r != this.rows; r++) {
                    var s = t[r];
                    e[n++] = "<li>", e[n++] = '<a href="', e[n++] = this.campaign ? c.setMediumCampaign(s.url, "widget", "Forum Widget") : s.url, e[n++] = '" title="', e[n++] = s.title, e[n++] = '">', e[n++] = s.title, e[n++] = "</a>", e[n++] = "</li>"
                }
    ...
    19: [function(t, e, n) {
        (function(e) {
            ...
            ! function() {
                e.env.BUILD.id && i.log("=== Build " + e.env.BUILD.id + " ==="), i.log("Initialize. Looking for target elements");
                var t = [];
                for (var n in f)
                    if (f.hasOwnProperty(n)) {
                        var s = document.getElementsByClassName(n);
                        s.length > 0 && i.log('Found "' + n + '"');
                        for (var o = 0; o < s.length; o++) t.push({
                            el: s[o],
                            cn: f[n]
                        })
                    }
                if (0 == t.length) return void i.warn("No target elements found! Cannot create widgets.");
                var a = h + "widget.css";
                e.env.BUILD.id && (a += "?" + e.env.BUILD.id), r(a);
    ...
    20: [function(t, e, n) {
        (function(n) {
            function r(t) {
                if (l.log("Create NewsWidget"), o.call(this, t), this.rate = NaN, this.last = NaN, null != this.cur) {
                ...
                this.build(), this.el.addClass(this.postBuildClasses.join(" ")), a(c + "news.json", 6e5, s.bind(this.processFeed, this))
            }
            var i = t("jquery"),
                s = t("underscore"),
                o = t("./widget"),
            ...
            r.prototype = Object.create(o.prototype), r.prototype.constructor = r, r.prototype.build = function() {
                ...
                for (var e = [], n = 0, r = 0; r < t.length && r != this.rows; r++) {
                    var s = t[r];
                    e[n++] = "<li>", e[n++] = '<a href="', e[n++] = this.campaign ? h.setMediumCampaign(s.url, "widget", "News Widget") : s.url, e[n++] = '" title="', e[n++] = s.title, e[n++] = '">', e[n++] = s.title, e[n++] = "</a>", e[n++] = "</li>"
                }
                i("ul", this.el).html(e.join(""))
            }, r.prototype.processSpot = function(t) {
                ...
                if (i(".arrow", this.el).removeClass("up down"), this.rate > this.last) {
                    i(".p-wrap", this.el).prepend(t), i(".p-wrap", this.el).attr("style", "transition: none !important; top: " + (-e + "px") + " !important"), window.setTimeout(s.bind(function() {
                        i(".p-wrap", this.el).attr("style", "top: 0 !important")
                    }, this), 50), window.setTimeout(s.bind(function() {
                        i(".p-wrap p:last-child", this.el).remove(), i(".p-wrap", this.el).attr("style", null)
                    }, this), 550);
                ...
                if (this.rate < this.last) {
                    i(".p-wrap", this.el).append(t), i(".p-wrap", this.el).attr("style", "top: " + (-e + "px !important")), window.setTimeout(s.bind(function() {
                        i(".p-wrap p:first-child", this.el).remove(), i(".p-wrap", this.el).attr("style", "transition: none !important; top: 0 !important")
                    }, this), 500), window.setTimeout(s.bind(function() {
    ...
    21: [function(t, e, n) {
        (function(n) {
            function r(t) {
                l.log("Create NewsTicker"), o.call(this, t), this.stories = [], this.index = -1, this.build(), this.el.addClass(this.postBuildClasses.join(" ")), a(u + "news.json", 15e5, s.bind(this.processFeed, this)), window.setInterval(s.bind(this.showNext, this), 7500)
            }
            var i = t("jquery"),
                s = t("underscore"),
                o = t("./widget"),
            ...
            r.prototype = Object.create(o.prototype), r.prototype.constructor = r, r.prototype.build = function() {
                ...
                if (0 != this.stories.length) {
                    ...
                    t[e++] = "<li>", t[e++] = '<a href="', t[e++] = n.url, t[e++] = '" title="', t[e++] = n.title, t[e++] = '">', t[e++] = n.title, t[e++] = "</a>", t[e++] = "</li>", i("ul", this.el).append(t.join(""));
                    var r = i("ul li:first-child", this.el).height();
                    i("ul", this.el).attr("style", "top: " + (-r + "px !important")), window.setTimeout(s.bind(function() {
                        i("ul li:first-child", this.el).remove(), i("ul", this.el).attr("style", "transition: none !important; top: 0 !important")
                    }, this), 500), window.setTimeout(s.bind(function() {
    ...
    22: [function(t, e, n) {
        (function(n) {
            function r(t) {
                l.log("Create PoolWidget"), o.call(this, t), this.last = {
                    terahash: NaN,
                    stamp: 0
                }, this.key = "btcwdgt-pool";
                var e = h.getObj(this.key);
                null != e && e.terahash && (this.last.terahash = e.terahash), this.build(), this.el.addClass(this.postBuildClasses.join(" ")), a(u + "pool.json", 6e5, s.bind(this.processData, this))
            }
            var i = t("jquery"),
                s = t("underscore"),
                o = t("./widget"),
            ...
            r.prototype = Object.create(o.prototype), r.prototype.constructor = r, r.prototype.build = function() {
                ...
                if (t.stamp && t.terahash) {
                    ...
                    if (i(".arrow", this.el).removeClass("up down"), t.terahash > this.last.terahash) {
                        i("ul", this.el).prepend(r), i("ul", this.el).attr("style", "transition: none !important; top: " + (-o + "px") + " !important"), window.setTimeout(s.bind(function() {
                            i("ul", this.el).attr("style", "top: 0 !important")
                        }, this), 50), window.setTimeout(s.bind(function() {
                            i("ul li:last-child", this.el).remove(), i("ul", this.el).attr("style", null)
                        }, this), 550);
                    ...
                    if (t.terahash < this.last.terahash) {
                        i("ul", this.el).append(r), i("ul", this.el).attr("style", "top: " + (-o + "px !important")), window.setTimeout(s.bind(function() {
                            i("ul li:first-child", this.el).remove(), i("ul", this.el).attr("style", "transition: none !important; top: 0 !important")
                        }, this), 500), window.setTimeout(s.bind(function() {
                            i("ul", this.el).attr("style", null)
                        }, this), 1e3);
                    ...
                    }(isNaN(this.last.terahash) || t.terahash == this.last.terahash) && i("li", this.el).replaceWith(r), i(".btcwdgt-body span", this.el).html(d.siPrefix(t.terahash, 12) + "Hash/s (BCH)"), this.last = t, h.setObj(this.key, this.last)
                }
            }, e.exports = r
        }).call(this, t("_process"))
    }, {
    ...
    23: [function(t, e, n) {
        (function(n) {
            function r(t) {
                a.log("Create PriceWidget"), o.call(this, t), this.rate = NaN, this.last = NaN, null == this.cur && (this.cur = "USD", this.cl = "usd"), this.key = "btcwdgt-price-" + this.cl;
            ...
            r.prototype = Object.create(o.prototype), r.prototype.constructor = r, r.prototype.build = function() {
                ...
                if ("JPY" == this.cur) var t = i("<li/>").text(this.rate.toFixed(0));
                var e = i("ul li:first-child", this.el).height();
                if (i(".arrow", this.el).removeClass("up down"), this.rate > this.last) {
                    i("ul", this.el).prepend(t), i("ul", this.el).attr("style", "transition: none !important; top: " + (-e + "px") + " !important"), window.setTimeout(s.bind(function() {
                        i("ul", this.el).attr("style", "top: 0 !important")
                    }, this), 50), window.setTimeout(s.bind(function() {
                        i("ul li:last-child", this.el).remove(), i("ul", this.el).attr("style", null)
                    }, this), 550);
                ...
                if (this.rate < this.last) {
                    i("ul", this.el).append(t), i("ul", this.el).attr("style", "top: " + (-e + "px !important")), window.setTimeout(s.bind(function() {
                        i("ul li:first-child", this.el).remove(), i("ul", this.el).attr("style", "transition: none !important; top: 0 !important")
                    }, this), 500), window.setTimeout(s.bind(function() {
                        i("ul", this.el).attr("style", null)
                    }, this), 1e3);
    ...
    24: [function(t, e, n) {
        (function(e) {
            e.env.BASE = "https://widgets.bitcoin.com/", e.env.BCX = "https://index-api.bitcoin.com/api/v0/", e.env.WS = "wss://index-api.bitcoin.com/ws", e.env.BUILD = t("./build"), t("./main")
        }).call(this, t("_process"))
    }, {
        "./build": 12,
        "./main": 19,
    ...
    26: [function(t, e, n) {
        (function(t) {
            ...
            function r(t, e) {
                window[o].register(t, e), window[o].connect()
            }
            ...
            n.prototype.register = function(t, e) {
                ...
                if (null === this.socket) try {
                    this.socket = new WebSocket(s), this.socket.onopen = this.onOpen.bind(this), this.socket.onclose = this.onClose.bind(this), this.socket.onmessage = this.onMessage.bind(this)
                } catch (t) {}
            ...
            o in window && window.hasOwnProperty(o) || (window[o] = new n), e.exports = {
                register: r,
                subscribe: i
            }
        }).call(this, t("_process"))
    ...
    28: [function(t, e, n) {
        function r(t) {
            this.el = i(t), this.campaign = !("off" == this.el.attr("bw-campaign")), this.cur = null, this.cl = null;
            var e = this.el.attr("bw-cur");
            "string" == typeof e && s.available(e) && (a.log("Got currency: " + e.toUpperCase()), this.cur = e.toUpperCase(), this.cl = e.toLowerCase()), this.cash = "true" == this.el.attr("bw-cash"), this.cash && a.log("Bitcoin Cash base currency"), this.rows = 5;
            var n = parseInt(this.el.attr("bw-entries"), 10);
            switch (isNaN(n) || (this.rows = Math.max(1, Math.min(10, n))), this.postBuildClasses = [], "true" == this.el.attr("bw-noshadow") && this.postBuildClasses.push("btcwdgt-noshadow"), this.colors = o["default"], this.el.attr("bw-theme")) {
                case "light":
                    this.postBuildClasses.push("btcwdgt-light"), this.colors = o.light
            }
